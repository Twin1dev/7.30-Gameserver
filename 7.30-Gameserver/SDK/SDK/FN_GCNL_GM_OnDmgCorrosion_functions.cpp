...
class UClass* AGCNL_GM_OnDmgCorrosion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_GM_OnDmgCorrosion_C");

	return Clss;
}


// GCNL_GM_OnDmgCorrosion_C GCNL_GM_OnDmgCorrosion.Default__GCNL_GM_OnDmgCorrosion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_GM_OnDmgCorrosion_C* AGCNL_GM_OnDmgCorrosion_C::GetDefaultObj()
{
	static class AGCNL_GM_OnDmgCorrosion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_GM_OnDmgCorrosion_C*>(AGCNL_GM_OnDmgCorrosion_C::StaticClass()->DefaultObject);
