...
class UClass* UItemInspectEvolutionIngredientsList_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemInspectEvolutionIngredientsList_C");

	return Clss;
}


// ItemInspectEvolutionIngredientsList_C ItemInspectEvolutionIngredientsList.Default__ItemInspectEvolutionIngredientsList_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemInspectEvolutionIngredientsList_C* UItemInspectEvolutionIngredientsList_C::GetDefaultObj()
{
	static class UItemInspectEvolutionIngredientsList_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemInspectEvolutionIngredientsList_C*>(UItemInspectEvolutionIngredientsList_C::StaticClass()->DefaultObject);
