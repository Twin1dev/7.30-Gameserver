...
class UClass* UGA_Ranged_GenericProjectileImpact_HookGun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Ranged_GenericProjectileImpact_HookGun_C");

	return Clss;
}


// GA_Ranged_GenericProjectileImpact_HookGun_C GA_Ranged_GenericProjectileImpact_HookGun.Default__GA_Ranged_GenericProjectileImpact_HookGun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Ranged_GenericProjectileImpact_HookGun_C* UGA_Ranged_GenericProjectileImpact_HookGun_C::GetDefaultObj()
{
	static class UGA_Ranged_GenericProjectileImpact_HookGun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Ranged_GenericProjectileImpact_HookGun_C*>(UGA_Ranged_GenericProjectileImpact_HookGun_C::StaticClass()->DefaultObject);
