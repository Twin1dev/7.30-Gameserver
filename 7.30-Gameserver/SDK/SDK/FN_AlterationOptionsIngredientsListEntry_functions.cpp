...
class UClass* UAlterationOptionsIngredientsListEntry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AlterationOptionsIngredientsListEntry_C");

	return Clss;
}


// AlterationOptionsIngredientsListEntry_C AlterationOptionsIngredientsListEntry.Default__AlterationOptionsIngredientsListEntry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAlterationOptionsIngredientsListEntry_C* UAlterationOptionsIngredientsListEntry_C::GetDefaultObj()
{
	static class UAlterationOptionsIngredientsListEntry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAlterationOptionsIngredientsListEntry_C*>(UAlterationOptionsIngredientsListEntry_C::StaticClass()->DefaultObject);
