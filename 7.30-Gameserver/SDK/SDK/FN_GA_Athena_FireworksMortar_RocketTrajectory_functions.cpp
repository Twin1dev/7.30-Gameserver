...
class UClass* UGA_Athena_FireworksMortar_RocketTrajectory_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_FireworksMortar_RocketTrajectory_C");

	return Clss;
}


// GA_Athena_FireworksMortar_RocketTrajectory_C GA_Athena_FireworksMortar_RocketTrajectory.Default__GA_Athena_FireworksMortar_RocketTrajectory_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_FireworksMortar_RocketTrajectory_C* UGA_Athena_FireworksMortar_RocketTrajectory_C::GetDefaultObj()
{
	static class UGA_Athena_FireworksMortar_RocketTrajectory_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_FireworksMortar_RocketTrajectory_C*>(UGA_Athena_FireworksMortar_RocketTrajectory_C::StaticClass()->DefaultObject);
...
void UGA_Athena_FireworksMortar_RocketTrajectory_C::SpawnLocationAndRotation(struct FVector* OutLoc, struct FRotator* OutRot, class AFortPlayerPawn* CallFunc_GetOwningPlayer_Player_Pawn, class AFortPlayerPawn* CallFunc_GetOwningPlayer_Player_Pawn1, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue, const struct FRotator& CallFunc_GetDefaultTargetingRotation_ReturnValue, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, float CallFunc_BreakRotator_Roll1, float CallFunc_BreakRotator_Pitch1, float CallFunc_BreakRotator_Yaw1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, float CallFunc_FMin_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue)
{
	static class UFunction* Func = nullptr;
