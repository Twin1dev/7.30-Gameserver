...
class UClass* ABGA_Athena_Balloons_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BGA_Athena_Balloons_C");

	return Clss;
}


// BGA_Athena_Balloons_C BGA_Athena_Balloons.Default__BGA_Athena_Balloons_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABGA_Athena_Balloons_C* ABGA_Athena_Balloons_C::GetDefaultObj()
{
	static class ABGA_Athena_Balloons_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABGA_Athena_Balloons_C*>(ABGA_Athena_Balloons_C::StaticClass()->DefaultObject);
