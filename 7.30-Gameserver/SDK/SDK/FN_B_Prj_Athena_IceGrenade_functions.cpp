...
class UClass* AB_Prj_Athena_IceGrenade_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_Athena_IceGrenade_C");

	return Clss;
}


// B_Prj_Athena_IceGrenade_C B_Prj_Athena_IceGrenade.Default__B_Prj_Athena_IceGrenade_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_Athena_IceGrenade_C* AB_Prj_Athena_IceGrenade_C::GetDefaultObj()
{
	static class AB_Prj_Athena_IceGrenade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Athena_IceGrenade_C*>(AB_Prj_Athena_IceGrenade_C::StaticClass()->DefaultObject);
