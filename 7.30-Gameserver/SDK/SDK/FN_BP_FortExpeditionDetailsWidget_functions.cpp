...
class UClass* UBP_FortExpeditionDetailsWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FortExpeditionDetailsWidget_C");

	return Clss;
}


// BP_FortExpeditionDetailsWidget_C BP_FortExpeditionDetailsWidget.Default__BP_FortExpeditionDetailsWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_FortExpeditionDetailsWidget_C* UBP_FortExpeditionDetailsWidget_C::GetDefaultObj()
{
	static class UBP_FortExpeditionDetailsWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FortExpeditionDetailsWidget_C*>(UBP_FortExpeditionDetailsWidget_C::StaticClass()->DefaultObject);
