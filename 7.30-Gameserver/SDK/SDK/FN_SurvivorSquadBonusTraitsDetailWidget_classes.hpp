...
public:
	...
	struct FSlateBrush                           HighlightedCheckmarkBrush;                         // 0x370(0x88)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           NormalCheckmarkBrush;                              // 0x3F8(0x88)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FSlateBrush                           NonMatchBrush;                                     // 0x480(0x88)(Edit, BlueprintVisible, DisableEditOnInstance)
