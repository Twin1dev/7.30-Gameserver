...
public:
	...
	class FText                                  CallFunc_Array_Get_Item;                           // 0xB8(0x18)(None)
	TSoftObjectPtr<class UTexture2D>             CallFunc_Array_Get_Item1;                          // 0xD0(0x28)(HasGetValueTypeHash)
	struct FFortToastDisplayInfo                 K2Node_MakeStruct_FortToastDisplayInfo;            // 0xF8(0x60)(None)
};
...
public:
	...
	struct FFortUITutorialData                   CallFunc_GetTutorialData_OutTutorialData;          // 0x80(0x58)(None)
	...
	struct FFortToastDisplayInfo                 CallFunc_GetTutorialCalloutData_FortToastDisplayInfo; // 0xE0(0x60)(None)
};
