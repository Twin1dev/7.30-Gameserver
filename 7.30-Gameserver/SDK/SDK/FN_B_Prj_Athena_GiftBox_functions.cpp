...
class UClass* AB_Prj_Athena_GiftBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_Athena_GiftBox_C");

	return Clss;
}


// B_Prj_Athena_GiftBox_C B_Prj_Athena_GiftBox.Default__B_Prj_Athena_GiftBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_Athena_GiftBox_C* AB_Prj_Athena_GiftBox_C::GetDefaultObj()
{
	static class AB_Prj_Athena_GiftBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Athena_GiftBox_C*>(AB_Prj_Athena_GiftBox_C::StaticClass()->DefaultObject);
...
// TArray<struct FDataTableRowHandle> K2Node_MakeArray_Array2                                          (ZeroConstructor, ReferenceParm)
...
// class UFortQuestItemDefinition*    CallFunc_Array_Get_Item2                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TArray<enum class EObjectTypeQuery>K2Node_MakeArray_Array4                                          (ConstParm, ZeroConstructor, ReferenceParm)
...
void AB_Prj_Athena_GiftBox_C::CalculateCardinalDirection(class APawn* CallFunc_GetInstigator_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_Abs_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue2)
{
	static class UFunction* Func = nullptr;
...
// class UBuildingStructuralSupportSystem*CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_Map_Find_Value3                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FVector                     CallFunc_Add_VectorVector_ReturnValue7                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector                     CallFunc_Add_VectorVector_ReturnValue8                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsDedicatedServer_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// float                              CallFunc_Map_Find_Value4                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
