...
public:
	...
	uint8                                        Pad_333C[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x90(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x100(0x18)(None)
	...
	struct FSlateColor                           K2Node_Select_Default;                             // 0x120(0x28)(None)
};
