...
class UClass* AGCN_Loop_Ice_Deimos_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_Ice_Deimos_C");

	return Clss;
}


// GCN_Loop_Ice_Deimos_C GCN_Loop_Ice_Deimos.Default__GCN_Loop_Ice_Deimos_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_Ice_Deimos_C* AGCN_Loop_Ice_Deimos_C::GetDefaultObj()
{
	static class AGCN_Loop_Ice_Deimos_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_Ice_Deimos_C*>(AGCN_Loop_Ice_Deimos_C::StaticClass()->DefaultObject);
