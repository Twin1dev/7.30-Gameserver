...
class UClass* ATheaterCamera_Blueprint_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TheaterCamera_Blueprint_C");

	return Clss;
}


// TheaterCamera_Blueprint_C TheaterCamera_Blueprint.Default__TheaterCamera_Blueprint_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATheaterCamera_Blueprint_C* ATheaterCamera_Blueprint_C::GetDefaultObj()
{
	static class ATheaterCamera_Blueprint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATheaterCamera_Blueprint_C*>(ATheaterCamera_Blueprint_C::StaticClass()->DefaultObject);
