...
class UClass* ABP_FortniteUpgrades_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FortniteUpgrades_C");

	return Clss;
}


// BP_FortniteUpgrades_C BP_FortniteUpgrades.Default__BP_FortniteUpgrades_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_FortniteUpgrades_C* ABP_FortniteUpgrades_C::GetDefaultObj()
{
	static class ABP_FortniteUpgrades_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_FortniteUpgrades_C*>(ABP_FortniteUpgrades_C::StaticClass()->DefaultObject);
