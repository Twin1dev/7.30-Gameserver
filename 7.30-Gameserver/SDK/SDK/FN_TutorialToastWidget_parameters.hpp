...
public:
	...
	uint8                                        Pad_5A4C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortToastDisplayInfo                 K2Node_CustomEvent_DispalyInfo;                    // 0x20(0x60)(None)
	...
	struct FFortToastDisplayInfo                 K2Node_MakeStruct_FortToastDisplayInfo;            // 0xB8(0x60)(None)
