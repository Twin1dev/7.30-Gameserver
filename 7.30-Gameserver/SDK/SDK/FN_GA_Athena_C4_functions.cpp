...
class UClass* UGA_Athena_C4_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_C4_C");

	return Clss;
}


// GA_Athena_C4_C GA_Athena_C4.Default__GA_Athena_C4_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_C4_C* UGA_Athena_C4_C::GetDefaultObj()
{
	static class UGA_Athena_C4_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_C4_C*>(UGA_Athena_C4_C::StaticClass()->DefaultObject);
