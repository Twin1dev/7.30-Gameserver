...
public:
	...
	uint8                                        Pad_4F00[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4F03[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Array_AddUnique_ReturnValue;              // 0xE4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_AddUnique_ReturnValue1;             // 0xE8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_Array_AddUnique_ReturnValue2;             // 0xF0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_K2_AttachToComponent_ReturnValue1;        // 0x112(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam1;               // 0x1F0(0x80)(IsPlainOldData, NoDestructor)
	TArray<struct FParticleSysParam>             K2Node_MakeArray_Array1;                           // 0x270(0x10)(ZeroConstructor, ReferenceParm)
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam2;               // 0x280(0x80)(IsPlainOldData, NoDestructor)
	...
	struct FParticleSysParam                     K2Node_MakeStruct_ParticleSysParam3;               // 0x310(0x80)(IsPlainOldData, NoDestructor)
	bool                                         CallFunc_K2_AttachToComponent_ReturnValue2;        // 0x390(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4F0B[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FParticleSysParam>             K2Node_MakeArray_Array2;                           // 0x398(0x10)(ZeroConstructor, ReferenceParm)
