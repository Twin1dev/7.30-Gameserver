...
class UClass* UGAB_PlayerDBNOResurrect_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_PlayerDBNOResurrect_C");

	return Clss;
}


// GAB_PlayerDBNOResurrect_C GAB_PlayerDBNOResurrect.Default__GAB_PlayerDBNOResurrect_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_PlayerDBNOResurrect_C* UGAB_PlayerDBNOResurrect_C::GetDefaultObj()
{
	static class UGAB_PlayerDBNOResurrect_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_PlayerDBNOResurrect_C*>(UGAB_PlayerDBNOResurrect_C::StaticClass()->DefaultObject);
