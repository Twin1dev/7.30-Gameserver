...
class UClass* AGCL_IntelPack_Highlight_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_IntelPack_Highlight_C");

	return Clss;
}


// GCL_IntelPack_Highlight_C GCL_IntelPack_Highlight.Default__GCL_IntelPack_Highlight_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_IntelPack_Highlight_C* AGCL_IntelPack_Highlight_C::GetDefaultObj()
{
	static class AGCL_IntelPack_Highlight_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_IntelPack_Highlight_C*>(AGCL_IntelPack_Highlight_C::StaticClass()->DefaultObject);
