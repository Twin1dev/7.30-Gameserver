...
public:
	...
	class UFortWorldItemDefinition*              SnowmanItemDef;                                    // 0x960(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UFortItem*>                     SnowmanItemInstances;                              // 0x968(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
