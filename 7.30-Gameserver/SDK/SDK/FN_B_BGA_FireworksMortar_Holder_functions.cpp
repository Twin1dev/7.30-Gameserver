...
class UClass* AB_BGA_FireworksMortar_Holder_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_BGA_FireworksMortar_Holder_C");

	return Clss;
}


// B_BGA_FireworksMortar_Holder_C B_BGA_FireworksMortar_Holder.Default__B_BGA_FireworksMortar_Holder_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_BGA_FireworksMortar_Holder_C* AB_BGA_FireworksMortar_Holder_C::GetDefaultObj()
{
	static class AB_BGA_FireworksMortar_Holder_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_BGA_FireworksMortar_Holder_C*>(AB_BGA_FireworksMortar_Holder_C::StaticClass()->DefaultObject);
