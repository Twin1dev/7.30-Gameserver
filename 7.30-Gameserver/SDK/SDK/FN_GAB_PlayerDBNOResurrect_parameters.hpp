...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable2;                             // 0xC8(0x20)(None)
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0x1F0(0x80)(None)
	struct FGameplayAbilityActorInfo             CallFunc_GetActorInfo_ReturnValue;                 // 0x270(0x40)(ContainsInstancedReference)
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0x2B0(0x100)(None)
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue;            // 0x3C4(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Conv_RotatorToVector_ReturnValue;         // 0x3E8(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_EBD[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue;          // 0x508(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetActorLocation_ReturnValue1;         // 0x544(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Subtract_VectorVector_ReturnValue;        // 0x550(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Normal_ReturnValue;                       // 0x55C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x5A0(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_K2_GetComponentRotation_ReturnValue;      // 0x5AC(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
