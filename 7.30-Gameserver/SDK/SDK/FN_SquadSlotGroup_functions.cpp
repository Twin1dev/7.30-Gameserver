...
class UClass* USquadSlotGroup_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SquadSlotGroup_C");

	return Clss;
}


// SquadSlotGroup_C SquadSlotGroup.Default__SquadSlotGroup_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USquadSlotGroup_C* USquadSlotGroup_C::GetDefaultObj()
{
	static class USquadSlotGroup_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USquadSlotGroup_C*>(USquadSlotGroup_C::StaticClass()->DefaultObject);
