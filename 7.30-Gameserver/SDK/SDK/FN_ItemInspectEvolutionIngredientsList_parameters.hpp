...
public:
	...
	uint8                                        Pad_4553[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateColor                           K2Node_Select_Default;                             // 0xF8(0x28)(None)
};
...
public:
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item;                           // 0x30(0x40)(None)
