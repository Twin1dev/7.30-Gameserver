...
struct ABP_Decal_Snow_WorldImpact_C_ExecuteUbergraph_BP_Decal_Snow_WorldImpact_Params
{
public:
	...
	struct FHitResult                            CallFunc_K2_AddActorLocalRotation_SweepHitResult;  // 0x14(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
