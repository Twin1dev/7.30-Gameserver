...
void UUserDefinedCaptureProtocol::StartCapturingFinalPixels(class FName StreamName)
{
	static class UFunction* Func = nullptr;
...
// UDelegateProperty_                 Handler                                                          (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, class FName BufferName, UDelegateProperty_ Handler)
{
	static class UFunction* Func = nullptr;
...
void UUserDefinedCaptureProtocol::PushBufferToStream(class UTexture* Buffer, class FName StreamName)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UserDefinedCaptureProtocol", "PushBufferToStream");

	Params::UUserDefinedCaptureProtocol_PushBufferToStream_Params Parms{};
...
void UUserDefinedCaptureProtocol::BindToStream(class FName StreamName, UDelegateProperty_ Handler)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UserDefinedCaptureProtocol", "BindToStream");

	Params::UUserDefinedCaptureProtocol_BindToStream_Params Parms{};
...
void UUserDefinedImageCaptureProtocol::WriteImageToDisk(struct FCapturedPixels& PixelData, class FName StreamName, struct FFrameMetrics& FrameMetrics, bool bCopyImageData)
{
	static class UFunction* Func = nullptr;
...
class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForBuffer(class UTexture* Buffer, class FName StreamName)
{
	static class UFunction* Func = nullptr;
