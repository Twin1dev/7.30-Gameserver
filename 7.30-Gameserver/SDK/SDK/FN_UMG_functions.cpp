...
class UClass* INativeUserListEntry::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NativeUserListEntry");

	return Clss;
}


// NativeUserListEntry UMG.Default__NativeUserListEntry
// (Public, ClassDefaultObject, ArchetypeObject)

class INativeUserListEntry* INativeUserListEntry::GetDefaultObj()
{
	static class INativeUserListEntry* Default = nullptr;

	if (!Default)
		Default = static_cast<INativeUserListEntry*>(INativeUserListEntry::StaticClass()->DefaultObject);
...
bool INativeUserListEntry::IsListItemSelected()
{
	...
	if (!Func)
		Func = Class->GetFunction("NativeUserListEntry", "IsListItemSelected");

	Params::INativeUserListEntry_IsListItemSelected_Params Parms{};
...
bool INativeUserListEntry::IsListItemExpanded()
{
	...
	if (!Func)
		Func = Class->GetFunction("NativeUserListEntry", "IsListItemExpanded");

	Params::INativeUserListEntry_IsListItemExpanded_Params Parms{};
...
class UListViewBase* INativeUserListEntry::GetOwningListView()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("NativeUserListEntry", "GetOwningListView");

	Params::INativeUserListEntry_GetOwningListView_Params Parms{};
...
class UObject* IUserObjectListEntry::GetListItemObject()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UserObjectListEntry", "GetListItemObject");

	Params::IUserObjectListEntry_GetListItemObject_Params Parms{};
