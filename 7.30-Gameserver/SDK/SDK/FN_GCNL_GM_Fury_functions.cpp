...
class UClass* AGCNL_GM_Fury_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_GM_Fury_C");

	return Clss;
}


// GCNL_GM_Fury_C GCNL_GM_Fury.Default__GCNL_GM_Fury_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_GM_Fury_C* AGCNL_GM_Fury_C::GetDefaultObj()
{
	static class AGCNL_GM_Fury_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_GM_Fury_C*>(AGCNL_GM_Fury_C::StaticClass()->DefaultObject);
