...
{
public:
	uint8                                        Pad_2AF[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B5[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B7[0x29B];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B9[0x2F0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BA[0x37];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2BE[0x34];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2BF[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
