...
class UClass* ATrap_Athena_Spikes_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Trap_Athena_Spikes_C");

	return Clss;
}


// Trap_Athena_Spikes_C Trap_Athena_Spikes.Default__Trap_Athena_Spikes_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATrap_Athena_Spikes_C* ATrap_Athena_Spikes_C::GetDefaultObj()
{
	static class ATrap_Athena_Spikes_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATrap_Athena_Spikes_C*>(ATrap_Athena_Spikes_C::StaticClass()->DefaultObject);
