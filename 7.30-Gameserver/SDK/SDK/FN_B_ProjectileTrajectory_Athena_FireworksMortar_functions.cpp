...
class UClass* AB_ProjectileTrajectory_Athena_FireworksMortar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_ProjectileTrajectory_Athena_FireworksMortar_C");

	return Clss;
}


// B_ProjectileTrajectory_Athena_FireworksMortar_C B_ProjectileTrajectory_Athena_FireworksMortar.Default__B_ProjectileTrajectory_Athena_FireworksMortar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_ProjectileTrajectory_Athena_FireworksMortar_C* AB_ProjectileTrajectory_Athena_FireworksMortar_C::GetDefaultObj()
{
	static class AB_ProjectileTrajectory_Athena_FireworksMortar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_ProjectileTrajectory_Athena_FireworksMortar_C*>(AB_ProjectileTrajectory_Athena_FireworksMortar_C::StaticClass()->DefaultObject);
