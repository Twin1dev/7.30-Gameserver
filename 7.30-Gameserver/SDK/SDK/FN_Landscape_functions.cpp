...
class UClass* ALandscapeBlueprintCustomSimulationBrush::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LandscapeBlueprintCustomSimulationBrush");

	return Clss;
}


// LandscapeBlueprintCustomSimulationBrush Landscape.Default__LandscapeBlueprintCustomSimulationBrush
// (Public, ClassDefaultObject, ArchetypeObject)

class ALandscapeBlueprintCustomSimulationBrush* ALandscapeBlueprintCustomSimulationBrush::GetDefaultObj()
{
	static class ALandscapeBlueprintCustomSimulationBrush* Default = nullptr;

	if (!Default)
		Default = static_cast<ALandscapeBlueprintCustomSimulationBrush*>(ALandscapeBlueprintCustomSimulationBrush::StaticClass()->DefaultObject);
