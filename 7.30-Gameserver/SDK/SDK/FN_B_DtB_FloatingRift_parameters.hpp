...
public:
	...
	uint8                                        Pad_2A89[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGuid                                 K2Node_HandleMissionEvent_InMissionGuid;           // 0x1C4(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2A8D[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle;         // 0x1D8(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags;            // 0x240(0x20)(None)
	...
	uint8                                        Pad_2A90[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A92[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  K2Node_ComponentBoundEvent_EventName;              // 0x3B4(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_ComponentBoundEvent_EmitterTime;            // 0x3BC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        K2Node_ComponentBoundEvent_ParticleCount;          // 0x3C0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_NameName_ReturnValue;          // 0x3C4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
