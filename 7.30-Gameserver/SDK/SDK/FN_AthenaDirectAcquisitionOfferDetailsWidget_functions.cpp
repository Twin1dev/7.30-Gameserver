...
class UClass* UAthenaDirectAcquisitionOfferDetailsWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaDirectAcquisitionOfferDetailsWidget_C");

	return Clss;
}


// AthenaDirectAcquisitionOfferDetailsWidget_C AthenaDirectAcquisitionOfferDetailsWidget.Default__AthenaDirectAcquisitionOfferDetailsWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaDirectAcquisitionOfferDetailsWidget_C* UAthenaDirectAcquisitionOfferDetailsWidget_C::GetDefaultObj()
{
	static class UAthenaDirectAcquisitionOfferDetailsWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaDirectAcquisitionOfferDetailsWidget_C*>(UAthenaDirectAcquisitionOfferDetailsWidget_C::StaticClass()->DefaultObject);
...
bool UAthenaDirectAcquisitionOfferDetailsWidget_C::GetHasBattlepassStars(class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, int32 CallFunc_GetItemOfferCount_ReturnValue, bool CallFunc_GetMetaAsBool_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
int32 UAthenaDirectAcquisitionOfferDetailsWidget_C::GetOwnedIndex(bool Temp_bool_Variable, int32 Temp_int_Variable, int32 Temp_int_Variable1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, int32 CallFunc_GetQuantityRemaining_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, int32 K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
bool UAthenaDirectAcquisitionOfferDetailsWidget_C::DoesOfferAllowQuantity(class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, int32 CallFunc_GetQuantityRemaining_ReturnValue, int32 CallFunc_GetMaxConcurrentPurchases_ReturnValue, bool CallFunc_NotEqual_IntInt_ReturnValue, bool CallFunc_NotEqual_IntInt_ReturnValue1, bool CallFunc_OfferHasDenyRequirements_ReturnValue, bool CallFunc_IsUnique_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue2)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupPurchaseButtonStateAndText(bool CallFunc_IsDynamicBundle_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_DoesOfferAllowQuantity_ReturnValue, enum class ESlateVisibility Temp_byte_Variable, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, bool CallFunc_IsPriceInMTX_ReturnValue, enum class ESlateVisibility Temp_byte_Variable1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, const class FString& CallFunc_GetOfferId_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, int32 CallFunc_GetNumGrantedItems_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, enum class EOfferPurchaseError CallFunc_CanPurchaseOffer_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue3, bool CallFunc_IsLockedByRequirement_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
// enum class ESlateVisibility        Temp_byte_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESlateVisibility        Temp_byte_Variable1                                              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                        CallFunc_GetSalesText_NewParam                                   (None)
// bool                               Temp_bool_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ESlateVisibility        K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupDynamicBundle(bool AllOwned, bool NoneOwned, int32 UnownedItems, int32 OwnedItems, bool bIsBundle, bool CallFunc_IsDynamicBundle_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array1, class FText CallFunc_Format_ReturnValue, class FText CallFunc_Format_ReturnValue1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData2, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array2, class FText CallFunc_Format_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class FText CallFunc_GetSalesText_NewParam, bool Temp_bool_Variable, enum class ESlateVisibility K2Node_Select_Default, int32 CallFunc_Owned_Bundle_Item_Count_Owned_Items, int32 CallFunc_Owned_Bundle_Item_Count_UnOwned_Items, bool CallFunc_Owned_Bundle_Item_Count_bNoneOwned, bool CallFunc_Owned_Bundle_Item_Count_bAllOwned)
{
	static class UFunction* Func = nullptr;
...
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortItemQuantityPair       CallFunc_GetPrerollOfferItem_ItemQuantityPair                    (None)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupPrerollItemHeaderInfo(const struct FFortItemQuantityPair& PrerollOfferItem, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, const struct FFortItemQuantityPair& CallFunc_GetPrerollOfferItem_ItemQuantityPair, bool CallFunc_GetPrerollOfferItem_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, bool CallFunc_SetItemQuantityPairToRepresent_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
enum class ESlateVisibility UAthenaDirectAcquisitionOfferDetailsWidget_C::GetPagingVisibility(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::GetOfferDetailsSlotMargin(struct FMargin* Margin, enum class ESubGame Temp_byte_Variable, float Temp_float_Variable, float Temp_float_Variable1, float Temp_float_Variable2, float Temp_float_Variable3, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, enum class ESubGame CallFunc_GetSubGame_ReturnValue, float K2Node_Select_Default, const struct FMargin& K2Node_MakeStruct_Margin)
{
	static class UFunction* Func = nullptr;
...
// enum class EFortItemCardSize       K2Node_Select1_Default                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

enum class EFortItemCardSize UAthenaDirectAcquisitionOfferDetailsWidget_C::GetCardSize(enum class EFortItemCardSize Temp_byte_Variable, enum class EFortItemCardSize Temp_byte_Variable1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool Temp_bool_Variable, enum class ESubGame CallFunc_GetSubGame_ReturnValue, enum class EFortItemCardSize Temp_byte_Variable2, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, bool Temp_bool_Variable1, bool CallFunc_IsPrerollOffer_ReturnValue, enum class EFortItemCardSize K2Node_Select_Default, enum class EFortItemCardSize K2Node_Select1_Default)
{
	static class UFunction* Func = nullptr;
...
// bool                               CallFunc_IsInAthena_ReturnValue1                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// bool                               CallFunc_IsInAthena_ReturnValue2                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateFromOffer_RefreshButtons(enum class ESlateVisibility Temp_byte_Variable, bool Temp_bool_Variable, enum class EHorizontalAlignment Temp_byte_Variable1, enum class EHorizontalAlignment Temp_byte_Variable2, bool Temp_bool_Variable1, float Temp_float_Variable, float Temp_float_Variable1, bool Temp_bool_Variable2, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility Temp_byte_Variable4, bool CallFunc_IsInAthena_ReturnValue, bool CallFunc_IsInAthena_ReturnValue1, enum class EHorizontalAlignment K2Node_Select_Default, enum class ESlateVisibility K2Node_Select1_Default, bool CallFunc_IsInAthena_ReturnValue2, float K2Node_Select2_Default, bool CallFunc_IsNonRefundable_ReturnValue, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable3, enum class ESlateVisibility K2Node_Select3_Default)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_IsInAthena_ReturnValue1 = CallFunc_IsInAthena_ReturnValue1;
	Parms.K2Node_Select_Default = K2Node_Select_Default;
	Parms.K2Node_Select1_Default = K2Node_Select1_Default;
	Parms.CallFunc_IsInAthena_ReturnValue2 = CallFunc_IsInAthena_ReturnValue2;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdatePreviewButton(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UFortAccountItemDefinition* CallFunc_GetGrantedItemDefinition_ReturnValue, class UAthenaCosmeticItemDefinition* K2Node_DynamicCast_AsAthena_Cosmetic_Item_Definition, bool K2Node_DynamicCast_bSuccess, bool CallFunc_HasModifiableVariants_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESubGame                CallFunc_GetSubGame_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsPrerollOffer_ReturnValue1                             (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_EqualEqual_ByteByte_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanAND_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateViewedItem(class UFortItem* ViewedItem, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, bool CallFunc_IsPrerollOffer_ReturnValue, class UFortItemDefinition* CallFunc_GetItemDefinitionBP_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool CallFunc_IsPrerollOffer_ReturnValue1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_GetOfferInfo_ReturnValue1 = CallFunc_GetOfferInfo_ReturnValue1;
	Parms.CallFunc_GetSubGame_ReturnValue = CallFunc_GetSubGame_ReturnValue;
	Parms.CallFunc_IsPrerollOffer_ReturnValue1 = CallFunc_IsPrerollOffer_ReturnValue1;
	Parms.CallFunc_EqualEqual_ByteByte_ReturnValue = CallFunc_EqualEqual_ByteByte_ReturnValue;
	Parms.CallFunc_BooleanAND_ReturnValue = CallFunc_BooleanAND_ReturnValue;
...
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText                        CallFunc_HasCatalogOfferName_CatalogOfferName1                   (None)
// bool                               CallFunc_HasCatalogOfferName_ReturnValue1                        (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ESlateVisibility        K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateCatalogOfferName(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class FText CallFunc_HasCatalogOfferName_CatalogOfferName, bool CallFunc_HasCatalogOfferName_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, class FText CallFunc_HasCatalogOfferName_CatalogOfferName1, bool CallFunc_HasCatalogOfferName_ReturnValue1, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_GetOfferInfo_ReturnValue1 = CallFunc_GetOfferInfo_ReturnValue1;
	Parms.CallFunc_HasCatalogOfferName_CatalogOfferName1 = CallFunc_HasCatalogOfferName_CatalogOfferName1;
	Parms.CallFunc_HasCatalogOfferName_ReturnValue1 = CallFunc_HasCatalogOfferName_ReturnValue1;
	Parms.K2Node_Select_Default = K2Node_Select_Default;
...
// enum class EFortItemCardSize       CallFunc_GetCardSize_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortItemQuantityPair       CallFunc_GetGrantedItemQuantityPair_ItemQuantity                 (None)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupSaleInfo(bool bHasSale, const class FString& BannerOverrideTag, class FText NormalPrice, bool bHasBattlePassStars, int32 NumOfBattlePassStars, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility K2Node_Select1_Default)
{
	static class UFunction* Func = nullptr;
...
// int32                              CallFunc_GetNumBattlepassStars_ReturnValue1                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetHasBattlepassStars_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_GetHasBattlepassStars_ReturnValue1                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        CallFunc_GetNormalPrice_ReturnValue                              (None)
// enum class ECatalogSaleType        CallFunc_GetSaleType_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_EqualEqual_ByteByte_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ECatalogSaleType        CallFunc_GetSaleType_ReturnValue1                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                      CallFunc_GetBannerOverrideTag_ReturnValue                        (ZeroConstructor, HasGetValueTypeHash)
// bool                               CallFunc_EqualEqual_ByteByte_ReturnValue1                        (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        CallFunc_GetNormalPrice_ReturnValue1                             (None)
...
// class FString                      CallFunc_GetOfferId_ReturnValue                                  (ZeroConstructor, HasGetValueTypeHash)
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FString                      CallFunc_GetBannerOverrideTag_ReturnValue1                       (ZeroConstructor, HasGetValueTypeHash)
// class UFortMcpContext*             CallFunc_GetContext_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsOwned_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_Not_PreBool_ReturnValue1                                (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BooleanAND_ReturnValue1                                 (ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateSaleStatus(bool IsSaleItem, class UFortStoreFrontOfferInfo* OfferInfo, int32 CallFunc_GetNumBattlepassStars_ReturnValue, int32 CallFunc_GetNumBattlepassStars_ReturnValue1, bool CallFunc_GetHasBattlepassStars_ReturnValue, bool CallFunc_GetHasBattlepassStars_ReturnValue1, class FText CallFunc_GetNormalPrice_ReturnValue, enum class ECatalogSaleType CallFunc_GetSaleType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, enum class ECatalogSaleType CallFunc_GetSaleType_ReturnValue1, const class FString& CallFunc_GetBannerOverrideTag_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, bool CallFunc_Not_PreBool_ReturnValue, class FText CallFunc_GetNormalPrice_ReturnValue1, class FText CallFunc_GetSalePrice_SalePrice, bool CallFunc_GetSalePrice_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, const class FString& CallFunc_GetBannerOverrideTag_ReturnValue1, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsOwned_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue1, bool CallFunc_BooleanAND_ReturnValue1)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_GetNumBattlepassStars_ReturnValue1 = CallFunc_GetNumBattlepassStars_ReturnValue1;
	Parms.CallFunc_GetHasBattlepassStars_ReturnValue = CallFunc_GetHasBattlepassStars_ReturnValue;
	Parms.CallFunc_GetHasBattlepassStars_ReturnValue1 = CallFunc_GetHasBattlepassStars_ReturnValue1;
	Parms.CallFunc_GetNormalPrice_ReturnValue = CallFunc_GetNormalPrice_ReturnValue;
	Parms.CallFunc_GetSaleType_ReturnValue = CallFunc_GetSaleType_ReturnValue;
	Parms.CallFunc_EqualEqual_ByteByte_ReturnValue = CallFunc_EqualEqual_ByteByte_ReturnValue;
	Parms.CallFunc_GetSaleType_ReturnValue1 = CallFunc_GetSaleType_ReturnValue1;
	...
	Parms.CallFunc_GetOfferId_ReturnValue = CallFunc_GetOfferId_ReturnValue;
	Parms.CallFunc_GetOfferInfo_ReturnValue = CallFunc_GetOfferInfo_ReturnValue;
	Parms.CallFunc_GetBannerOverrideTag_ReturnValue1 = CallFunc_GetBannerOverrideTag_ReturnValue1;
	Parms.CallFunc_GetContext_ReturnValue = CallFunc_GetContext_ReturnValue;
	Parms.CallFunc_IsOwned_ReturnValue = CallFunc_IsOwned_ReturnValue;
	Parms.CallFunc_Not_PreBool_ReturnValue1 = CallFunc_Not_PreBool_ReturnValue1;
	Parms.CallFunc_BooleanAND_ReturnValue1 = CallFunc_BooleanAND_ReturnValue1;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdatePurchaseQuantity(class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetSalePrice_SalePrice, bool CallFunc_GetSalePrice_ReturnValue, class FText CallFunc_GetNormalPrice_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, int32 CallFunc_Add_IntInt_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, enum class EOfferPurchaseError CallFunc_CanPurchaseOffer_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, int32 CallFunc_GetQuantityRemaining_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateAvailability(int32 Temp_int_Variable, int32 Temp_int_Variable1, class UFortMcpContext* CallFunc_GetContext_ReturnValue, int32 CallFunc_GetOwnedIndex_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, const class FString& CallFunc_GetOfferId_ReturnValue, int32 CallFunc_GetQuantityRemaining_ReturnValue, bool CallFunc_IsOwned_ReturnValue, bool Temp_bool_Variable, int32 K2Node_Select_Default, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, int32 CallFunc_GetMaxConcurrentPurchases_ReturnValue, bool CallFunc_IsUnique_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue3, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_IsGiftOnly_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue, class FText CallFunc_MakeLiteralText_ReturnValue1)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::AttemptPurchase(class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, bool CallFunc_IsCardpack_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, int32 CallFunc_HasMaxLevel_MaxLevel, bool CallFunc_HasMaxLevel_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, class UAthenaDirectAcquisitionConfirmation_C* CallFunc_Create_ReturnValue, class UFortMcpProfileAthena* CallFunc_GetAthenaProfile_ReturnValue, int32 CallFunc_GetSeasonBookLevel_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, bool CallFunc_Greater_IntInt_ReturnValue, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_ShouldHavePurchaseConfirmation_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue3, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue4, bool CallFunc_IsPriceInMTX_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, enum class EOfferPurchaseError CallFunc_CanPurchaseOffer_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// enum class ESlateVisibility        K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue3                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_GetPriceItem_RequiredItemCount1                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortAccountItemDefinition*  CallFunc_GetPriceItem_ReturnValue1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupPrice(class UWidget* PriceContainer, class UTextBlock* NormalPriceText, class UWidget* SalePriceContainer, class UTextBlock* SalePriceText, class UImage* CurrencyImage, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, class FText CallFunc_GetSalePrice_SalePrice, bool CallFunc_GetSalePrice_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, int32 CallFunc_GetPriceItem_RequiredItemCount, class UFortAccountItemDefinition* CallFunc_GetPriceItem_ReturnValue, class FText CallFunc_GetNormalPrice_ReturnValue, const struct FSlateBrush& CallFunc_GetSmallPreviewImageBrush_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility K2Node_Select_Default, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue3, int32 CallFunc_GetPriceItem_RequiredItemCount1, class UFortAccountItemDefinition* CallFunc_GetPriceItem_ReturnValue1, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.K2Node_Select_Default = K2Node_Select_Default;
	Parms.CallFunc_GetOfferInfo_ReturnValue3 = CallFunc_GetOfferInfo_ReturnValue3;
	Parms.CallFunc_GetPriceItem_RequiredItemCount1 = CallFunc_GetPriceItem_RequiredItemCount1;
	Parms.CallFunc_GetPriceItem_ReturnValue1 = CallFunc_GetPriceItem_ReturnValue1;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::HandleBack(bool* PassThrough, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue1, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, bool CallFunc_IsPanelOnStack_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// class UFortStoreFrontOfferInfo*    CallFunc_Array_Get_Item1                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortStoreFrontOfferInfo*    CallFunc_GetOfferInfo_ReturnValue2                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortStoreFrontOfferInfo*    CallFunc_Array_Get_Item2                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GreaterEqual_IntInt_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UEnableMultiFactorAuthModalBP_C*CallFunc_Create_ReturnValue2                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::ExecuteUbergraph_AthenaDirectAcquisitionOfferDetailsWidget(int32 EntryPoint, enum class ESlateVisibility Temp_byte_Variable, class UFortMcpContext* CallFunc_GetContext_ReturnValue, const class FString& CallFunc_GetAffiliateName_ReturnValue, int32 Temp_int_Variable, class FText CallFunc_Conv_StringToText_ReturnValue, int32 CallFunc_Len_ReturnValue, enum class ESlateVisibility Temp_byte_Variable1, bool CallFunc_Greater_IntInt_ReturnValue, bool Temp_bool_Variable, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, enum class ESlateVisibility K2Node_Select_Default, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, int32 Temp_int_Variable1, class UCommonButton* K2Node_ComponentBoundEvent_Button7, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class UFortAccountItemDefinition* CallFunc_GetCurrencyItemDefinition_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue1, class UFortItemIcon* CallFunc_SpawnObject_ReturnValue, bool CallFunc_HasMfaBeenEnabledAtSomePoint_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue2, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_CustomInput_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue1, class UCommonButton* K2Node_ComponentBoundEvent_Button6, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue1, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Find_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button5, int32 CallFunc_Add_IntInt_ReturnValue1, int32 CallFunc_Percent_IntInt_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue2, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue3, int32 CallFunc_Array_Find_ReturnValue1, int32 CallFunc_Subtract_IntInt_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item2, bool CallFunc_GreaterEqual_IntInt_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue4, enum class ESlateVisibility Temp_byte_Variable2, class UCommonButton* K2Node_ComponentBoundEvent_Button4, class UCommonButton* K2Node_ComponentBoundEvent_Button3, bool CallFunc_HandleBack_Passthrough, enum class ESlateVisibility Temp_byte_Variable3, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue1, bool Temp_bool_Variable1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UFortItem* K2Node_CustomEvent_Item, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_IsValid_ReturnValue1, enum class ESlateVisibility K2Node_Select1_Default, bool CallFunc_IsMobileGame_ReturnValue1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue3, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, int32 CallFunc_GetNumGrantedItems_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button2, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue4, class UAthenaDirectAquisitionStyleScreen_C* CallFunc_Create_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue1, class UGiftingScreen_C* CallFunc_Create_ReturnValue1, class UEnableMultiFactorAuthModalBP_C* CallFunc_Create_ReturnValue2, bool CallFunc_QueueModal_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue1, bool CallFunc_IsMobileGame_ReturnValue2, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue5, enum class EOfferPurchaseError CallFunc_CanGiftOffer_Result, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue1, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, float CallFunc_GetDelayGiftButtonWhenMFANotEnabledSeconds_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue1, uint8 CallFunc_MakeLiteralByte_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, enum class ESubGame CallFunc_GetCurrentSubGame_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue1, enum class EFortDialogResult Temp_byte_Variable4, bool CallFunc_BooleanAND_ReturnValue2, class FName Temp_name_Variable, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, const struct FMargin& CallFunc_GetOfferDetailsSlotMargin_Margin, enum class ESlateVisibility CallFunc_GetPagingVisibility_ReturnValue, bool CallFunc_IsActivated_ReturnValue)
{
	static class UFunction* Func = nullptr;
