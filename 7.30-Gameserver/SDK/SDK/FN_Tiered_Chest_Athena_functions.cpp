...
class UClass* ATiered_Chest_Athena_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Tiered_Chest_Athena_C");

	return Clss;
}


// Tiered_Chest_Athena_C Tiered_Chest_Athena.Default__Tiered_Chest_Athena_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATiered_Chest_Athena_C* ATiered_Chest_Athena_C::GetDefaultObj()
{
	static class ATiered_Chest_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATiered_Chest_Athena_C*>(ATiered_Chest_Athena_C::StaticClass()->DefaultObject);
