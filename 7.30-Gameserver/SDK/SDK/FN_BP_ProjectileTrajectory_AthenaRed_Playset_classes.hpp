...
public:
	...
	class UAudioComponent*                       Creative_Grenade_LoopRed_Cue;                      // 0x418(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
