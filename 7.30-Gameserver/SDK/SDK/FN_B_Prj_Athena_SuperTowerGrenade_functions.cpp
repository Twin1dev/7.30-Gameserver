...
class UClass* AB_Prj_Athena_SuperTowerGrenade_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_Athena_SuperTowerGrenade_C");

	return Clss;
}


// B_Prj_Athena_SuperTowerGrenade_C B_Prj_Athena_SuperTowerGrenade.Default__B_Prj_Athena_SuperTowerGrenade_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_Athena_SuperTowerGrenade_C* AB_Prj_Athena_SuperTowerGrenade_C::GetDefaultObj()
{
	static class AB_Prj_Athena_SuperTowerGrenade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Athena_SuperTowerGrenade_C*>(AB_Prj_Athena_SuperTowerGrenade_C::StaticClass()->DefaultObject);
...
// class UBuildingStructuralSupportSystem*CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem1(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_Prj_Athena_SuperTowerGrenade_C::ClearOnly(TArray<struct FVector>& ClearedGridCells, bool DestroyFloorsQuickly, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Length_ReturnValue, const struct FVector& CallFunc_Array_Get_Item, int32 Temp_int_Loop_Counter_Variable, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem1, float CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	...
	Parms.CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem1 = CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem1;
...
void AB_Prj_Athena_SuperTowerGrenade_C::CalculateCardinalDirection(class APawn* CallFunc_GetInstigator_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_Abs_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue2)
{
	static class UFunction* Func = nullptr;
...
// class UBuildingStructuralSupportSystem*CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_Map_Find_Value2                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
