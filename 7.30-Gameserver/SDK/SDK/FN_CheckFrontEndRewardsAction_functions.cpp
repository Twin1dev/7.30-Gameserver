...
class UClass* ACheckFrontEndRewardsAction_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheckFrontEndRewardsAction_C");

	return Clss;
}


// CheckFrontEndRewardsAction_C CheckFrontEndRewardsAction.Default__CheckFrontEndRewardsAction_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACheckFrontEndRewardsAction_C* ACheckFrontEndRewardsAction_C::GetDefaultObj()
{
	static class ACheckFrontEndRewardsAction_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACheckFrontEndRewardsAction_C*>(ACheckFrontEndRewardsAction_C::StaticClass()->DefaultObject);
