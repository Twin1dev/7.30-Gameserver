...
public:
	...
	struct FFortBasicMissionInfo                 CallFunc_GetCurrentBasicMissionInfo_BasicMissionInfo; // 0x10(0x388)(None)
...
public:
	...
	uint8                                        Pad_3AF7[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3B04[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue1;           // 0x29(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_3B0E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
