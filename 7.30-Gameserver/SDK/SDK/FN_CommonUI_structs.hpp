...
public:
	...
	uint8                                        Pad_4DF[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4E3[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4E8[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FSoftSlateBrush                       GamepadBrushes[0x4];                               // 0x70(0x1C0)(Edit, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4F3[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
