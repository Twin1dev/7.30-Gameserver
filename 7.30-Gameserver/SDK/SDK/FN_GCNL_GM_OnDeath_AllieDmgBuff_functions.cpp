...
class UClass* AGCNL_GM_OnDeath_AllieDmgBuff_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_GM_OnDeath_AllieDmgBuff_C");

	return Clss;
}


// GCNL_GM_OnDeath_AllieDmgBuff_C GCNL_GM_OnDeath_AllieDmgBuff.Default__GCNL_GM_OnDeath_AllieDmgBuff_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_GM_OnDeath_AllieDmgBuff_C* AGCNL_GM_OnDeath_AllieDmgBuff_C::GetDefaultObj()
{
	static class AGCNL_GM_OnDeath_AllieDmgBuff_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_GM_OnDeath_AllieDmgBuff_C*>(AGCNL_GM_OnDeath_AllieDmgBuff_C::StaticClass()->DefaultObject);
...
bool AGCNL_GM_OnDeath_AllieDmgBuff_C::OnActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, class AEnemyPawn_Parent_C* K2Node_DynamicCast_AsEnemy_Pawn_Parent, bool K2Node_DynamicCast_bSuccess, const struct FParticleSysParam& K2Node_MakeStruct_ParticleSysParam, TArray<struct FParticleSysParam>& K2Node_MakeArray_Array, bool CallFunc_K2_AttachToComponent_ReturnValue, bool CallFunc_K2_AttachToComponent_ReturnValue1, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, bool CallFunc_K2_AttachToComponent_ReturnValue2, int32 CallFunc_GetVisualEffectQuality_ReturnValue, bool K2Node_SwitchInteger_CmpSuccess)
{
	...
	Params::AGCNL_GM_OnDeath_AllieDmgBuff_C_OnActive_Params Parms{};
...
void AGCNL_GM_OnDeath_AllieDmgBuff_C::OnRemoval(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	...
	Params::AGCNL_GM_OnDeath_AllieDmgBuff_C_OnRemoval_Params Parms{};
...
void AGCNL_GM_OnDeath_AllieDmgBuff_C::ExecuteUbergraph_GCNL_GM_OnDeath_AllieDmgBuff(int32 EntryPoint, bool Temp_bool_Variable, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& Temp_struct_Variable1, class AActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, class UCameraShake* K2Node_Event_BurstCameraShakeInstance, class ADecalActor* K2Node_Event_BurstDecalInstance, const struct FLinearColor& K2Node_Select_Default, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue, class AEnemyPawn_Parent_C* K2Node_DynamicCast_AsEnemy_Pawn_Parent, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::AGCNL_GM_OnDeath_AllieDmgBuff_C_ExecuteUbergraph_GCNL_GM_OnDeath_AllieDmgBuff_Params Parms{};
