...
class UClass* UItemDescriptionDetailWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemDescriptionDetailWidget_C");

	return Clss;
}


// ItemDescriptionDetailWidget_C ItemDescriptionDetailWidget.Default__ItemDescriptionDetailWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemDescriptionDetailWidget_C* UItemDescriptionDetailWidget_C::GetDefaultObj()
{
	static class UItemDescriptionDetailWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemDescriptionDetailWidget_C*>(UItemDescriptionDetailWidget_C::StaticClass()->DefaultObject);
