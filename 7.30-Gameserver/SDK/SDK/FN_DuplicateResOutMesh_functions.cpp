...
class UClass* ADuplicateResOutMesh_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DuplicateResOutMesh_C");

	return Clss;
}


// DuplicateResOutMesh_C DuplicateResOutMesh.Default__DuplicateResOutMesh_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADuplicateResOutMesh_C* ADuplicateResOutMesh_C::GetDefaultObj()
{
	static class ADuplicateResOutMesh_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADuplicateResOutMesh_C*>(ADuplicateResOutMesh_C::StaticClass()->DefaultObject);
