...
class UClass* AAthenaSupplyDropBalloon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaSupplyDropBalloon_C");

	return Clss;
}


// AthenaSupplyDropBalloon_C AthenaSupplyDropBalloon.Default__AthenaSupplyDropBalloon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAthenaSupplyDropBalloon_C* AAthenaSupplyDropBalloon_C::GetDefaultObj()
{
	static class AAthenaSupplyDropBalloon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAthenaSupplyDropBalloon_C*>(AAthenaSupplyDropBalloon_C::StaticClass()->DefaultObject);
