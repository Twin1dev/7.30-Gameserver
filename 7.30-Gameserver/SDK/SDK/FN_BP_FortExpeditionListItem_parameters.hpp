...
public:
	...
	struct FFortTagUIData                        CallFunc_GetUIDataForTag_OutData;                  // 0x18(0x368)(None)
...
public:
	...
	uint8                                        Pad_4B49[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortRarityItemData                   CallFunc_BPGetRarityData_ReturnValue;              // 0x10(0x80)(None)
};
...
public:
	...
	uint8                                        Pad_4B51[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x38(0x88)(None)
...
public:
	...
	uint8                                        Pad_4B57[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
