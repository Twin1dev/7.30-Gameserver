...
class UClass* UFullPartyMemberConnected_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FullPartyMemberConnected_C");

	return Clss;
}


// FullPartyMemberConnected_C FullPartyMemberConnected.Default__FullPartyMemberConnected_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFullPartyMemberConnected_C* UFullPartyMemberConnected_C::GetDefaultObj()
{
	static class UFullPartyMemberConnected_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFullPartyMemberConnected_C*>(UFullPartyMemberConnected_C::StaticClass()->DefaultObject);
