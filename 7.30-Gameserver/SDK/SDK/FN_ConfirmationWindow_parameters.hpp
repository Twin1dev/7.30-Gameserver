...
public:
	...
	uint8                                        Pad_10D7[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1;             // 0x1EC(0x10)(ZeroConstructor, NoDestructor)
...
public:
	...
	struct FFortDialogDescription_NUI            ResponseConfirmationDescription;                   // 0x8(0x118)(Edit, BlueprintVisible, ContainsInstancedReference)
	class FName                                  ResultName;                                        // 0x120(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        FoundIndex;                                        // 0x128(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1114[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UIconTextButton_C*                     K2Node_DynamicCast_AsIcon_Text_Button;             // 0x130(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                  CallFunc_GetResultName_ResultName;                 // 0x13C(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFortDialogExternalLatentActionHandle CallFunc_ProcessConfirmationResult_WaitingDialogHandle; // 0x150(0x4)(NoDestructor)
};
...
public:
	...
	uint8                                        Pad_1132[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1133[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0xE4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FConfirmationDialogAction             CallFunc_Array_Get_Item1;                          // 0xE8(0xC8)(None)
