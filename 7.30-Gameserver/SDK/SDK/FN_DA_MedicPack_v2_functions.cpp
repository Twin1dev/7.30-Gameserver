...
class UClass* ADA_MedicPack_v2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DA_MedicPack_v2_C");

	return Clss;
}


// DA_MedicPack_v2_C DA_MedicPack_v2.Default__DA_MedicPack_v2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADA_MedicPack_v2_C* ADA_MedicPack_v2_C::GetDefaultObj()
{
	static class ADA_MedicPack_v2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADA_MedicPack_v2_C*>(ADA_MedicPack_v2_C::StaticClass()->DefaultObject);
