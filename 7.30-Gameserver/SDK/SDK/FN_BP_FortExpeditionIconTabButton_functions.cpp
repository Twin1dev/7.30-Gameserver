...
class UClass* UBP_FortExpeditionIconTabButton_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FortExpeditionIconTabButton_C");

	return Clss;
}


// BP_FortExpeditionIconTabButton_C BP_FortExpeditionIconTabButton.Default__BP_FortExpeditionIconTabButton_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_FortExpeditionIconTabButton_C* UBP_FortExpeditionIconTabButton_C::GetDefaultObj()
{
	static class UBP_FortExpeditionIconTabButton_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FortExpeditionIconTabButton_C*>(UBP_FortExpeditionIconTabButton_C::StaticClass()->DefaultObject);
