...
public:
	...
	class FText                                  CallFunc_InternalToExternalRarity_ExternalRarity;  // 0x40(0x18)(None)
	...
	class FText                                  CallFunc_GetPrimaryCategory_ItemCategoryText;      // 0xD8(0x18)(None)
...
public:
	...
	class FText                                  CallFunc_GetShortDescription_ReturnValue;          // 0x18(0x18)(None)
	...
	class UFortTooltipContext*                   CallFunc_SpawnTooltipContextWithSource_ReturnValue; // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_GetCombinedDescription_OutDescription;    // 0x50(0x18)(None)
	bool                                         CallFunc_GetCombinedDescription_ReturnValue;       // 0x68(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_48DC[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetPeopleName_Result;                     // 0x60(0x18)(None)
	...
	uint8                                        Pad_48DD[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x80(0x18)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData;              // 0x98(0x40)(HasGetValueTypeHash)
	class FText                                  CallFunc_GetDisplayName_ReturnValue1;              // 0xD8(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x168(0x18)(None)
	class FText                                  CallFunc_GetDisplayName_ReturnValue2;              // 0x180(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x1E8(0x18)(None)
	...
	uint8                                        Pad_48E1[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
