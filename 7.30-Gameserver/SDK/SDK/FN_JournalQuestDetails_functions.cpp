...
class UClass* UJournalQuestDetails_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("JournalQuestDetails_C");

	return Clss;
}


// JournalQuestDetails_C JournalQuestDetails.Default__JournalQuestDetails_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UJournalQuestDetails_C* UJournalQuestDetails_C::GetDefaultObj()
{
	static class UJournalQuestDetails_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UJournalQuestDetails_C*>(UJournalQuestDetails_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_Get_Streaming_Attached_Quest_Name_ReturnValue           (None)
