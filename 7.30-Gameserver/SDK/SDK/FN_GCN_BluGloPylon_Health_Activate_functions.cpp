...
class UClass* AGCN_BluGloPylon_Health_Activate_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_BluGloPylon_Health_Activate_C");

	return Clss;
}


// GCN_BluGloPylon_Health_Activate_C GCN_BluGloPylon_Health_Activate.Default__GCN_BluGloPylon_Health_Activate_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_BluGloPylon_Health_Activate_C* AGCN_BluGloPylon_Health_Activate_C::GetDefaultObj()
{
	static class AGCN_BluGloPylon_Health_Activate_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_BluGloPylon_Health_Activate_C*>(AGCN_BluGloPylon_Health_Activate_C::StaticClass()->DefaultObject);
