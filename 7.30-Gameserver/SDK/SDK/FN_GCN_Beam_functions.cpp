...
class UClass* UGCN_Beam_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Beam_C");

	return Clss;
}


// GCN_Beam_C GCN_Beam.Default__GCN_Beam_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Beam_C* UGCN_Beam_C::GetDefaultObj()
{
	static class UGCN_Beam_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Beam_C*>(UGCN_Beam_C::StaticClass()->DefaultObject);
