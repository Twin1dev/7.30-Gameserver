...
public:
	...
	class FText                                  Temp_text_Variable1;                               // 0x100(0x18)(None)
	class FText                                  Temp_text_Variable2;                               // 0x118(0x18)(None)
	...
	class FText                                  Temp_text_Variable3;                               // 0x150(0x18)(None)
	class FText                                  Temp_text_Variable4;                               // 0x168(0x18)(None)
	class FText                                  Temp_text_Variable5;                               // 0x180(0x18)(None)
	class FText                                  K2Node_Select1_Default;                            // 0x198(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x1B8(0x18)(None)
	...
	class FText                                  K2Node_Select2_Default;                            // 0x1D8(0x18)(None)
};
