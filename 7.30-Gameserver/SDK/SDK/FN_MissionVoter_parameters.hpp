...
public:
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor1;                     // 0x90(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor2;                     // 0xB8(0x28)(None)
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue;            // 0xE0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue1;           // 0xE1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue2;           // 0xE2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
