...
// TDelegate<void(struct FCapturedPixels& Pixels, class FName StreamName, const struct FFrameMetrics& FrameMetrics)>Handler                                                (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void UUserDefinedCaptureProtocol::BindToStream(class FName StreamName, TDelegate<void(struct FCapturedPixels& Pixels, class FName StreamName, const struct FFrameMetrics& FrameMetrics)> Handler)
{
	static class UFunction* Func = nullptr;
	...
	Params::UserDefinedCaptureProtocol_BindToStream Parms{};
...
void UUserDefinedCaptureProtocol::PushBufferToStream(class UTexture* Buffer, class FName StreamName)
{
	...
	Params::UserDefinedCaptureProtocol_PushBufferToStream Parms{};
...
void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, class FName BufferName, TDelegate<void(struct FCapturedPixels& Pixels, class FName StreamName, const struct FFrameMetrics& FrameMetrics)> Handler)
{
	static class UFunction* Func = nullptr;
...
void UUserDefinedImageCaptureProtocol::WriteImageToDisk(const struct FCapturedPixels& PixelData, class FName StreamName, const struct FFrameMetrics& FrameMetrics, bool bCopyImageData)
{
	static class UFunction* Func = nullptr;
