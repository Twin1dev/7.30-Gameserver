...
class UClass* UItemInspectUpgradeCallout_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemInspectUpgradeCallout_C");

	return Clss;
}


// ItemInspectUpgradeCallout_C ItemInspectUpgradeCallout.Default__ItemInspectUpgradeCallout_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemInspectUpgradeCallout_C* UItemInspectUpgradeCallout_C::GetDefaultObj()
{
	static class UItemInspectUpgradeCallout_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemInspectUpgradeCallout_C*>(UItemInspectUpgradeCallout_C::StaticClass()->DefaultObject);
...
void UItemInspectUpgradeCallout_C::OnRequestUpgrade__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("ItemInspectUpgradeCallout_C", "OnRequestUpgrade__DelegateSignature");
