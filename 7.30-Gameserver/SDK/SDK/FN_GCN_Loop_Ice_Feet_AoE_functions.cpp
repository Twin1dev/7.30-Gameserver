...
class UClass* AGCN_Loop_Ice_Feet_AoE_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_Ice_Feet_AoE_C");

	return Clss;
}


// GCN_Loop_Ice_Feet_AoE_C GCN_Loop_Ice_Feet_AoE.Default__GCN_Loop_Ice_Feet_AoE_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_Ice_Feet_AoE_C* AGCN_Loop_Ice_Feet_AoE_C::GetDefaultObj()
{
	static class AGCN_Loop_Ice_Feet_AoE_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_Ice_Feet_AoE_C*>(AGCN_Loop_Ice_Feet_AoE_C::StaticClass()->DefaultObject);
