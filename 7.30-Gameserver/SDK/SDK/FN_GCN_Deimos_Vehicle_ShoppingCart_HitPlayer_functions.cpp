...
class UClass* UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C");

	return Clss;
}


// GCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C GCN_Deimos_Vehicle_ShoppingCart_HitPlayer.Default__GCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C* UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::GetDefaultObj()
{
	static class UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C*>(UGCN_Deimos_Vehicle_ShoppingCart_HitPlayer_C::StaticClass()->DefaultObject);
