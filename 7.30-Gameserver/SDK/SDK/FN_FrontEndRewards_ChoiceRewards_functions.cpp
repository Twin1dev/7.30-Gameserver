...
class UClass* UFrontEndRewards_ChoiceRewards_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FrontEndRewards_ChoiceRewards_C");

	return Clss;
}


// FrontEndRewards_ChoiceRewards_C FrontEndRewards_ChoiceRewards.Default__FrontEndRewards_ChoiceRewards_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFrontEndRewards_ChoiceRewards_C* UFrontEndRewards_ChoiceRewards_C::GetDefaultObj()
{
	static class UFrontEndRewards_ChoiceRewards_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFrontEndRewards_ChoiceRewards_C*>(UFrontEndRewards_ChoiceRewards_C::StaticClass()->DefaultObject);
