...
class UClass* UBP_ExpeditionSquadSlotsView_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_ExpeditionSquadSlotsView_C");

	return Clss;
}


// BP_ExpeditionSquadSlotsView_C BP_ExpeditionSquadSlotsView.Default__BP_ExpeditionSquadSlotsView_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_ExpeditionSquadSlotsView_C* UBP_ExpeditionSquadSlotsView_C::GetDefaultObj()
{
	static class UBP_ExpeditionSquadSlotsView_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_ExpeditionSquadSlotsView_C*>(UBP_ExpeditionSquadSlotsView_C::StaticClass()->DefaultObject);
