...
public:
	...
	uint8                                        Pad_4E8E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4E90[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayEventData                    K2Node_Event_EventData;                            // 0x30(0xA8)(ConstParm)
	class AActor*                                CallFunc_EffectContextGetInstigatorActor_ReturnValue; // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AB_Perk_C_Constructor_BASE_C*          K2Node_DynamicCast_AsB_Perk_C_Constructor_BASE;    // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xE8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4E93[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UAbilitySystemComponent*               CallFunc_GetAbilitySystemComponent_ReturnValue;    // 0xF0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0xF8(0x20)(None)
	...
	bool                                         CallFunc_ExecuteGC_Overflow;                       // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
