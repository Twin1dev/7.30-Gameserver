...
class UClass* UAnnouncement_Basic_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Announcement_Basic_C");

	return Clss;
}


// Announcement_Basic_C Announcement_Basic.Default__Announcement_Basic_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnnouncement_Basic_C* UAnnouncement_Basic_C::GetDefaultObj()
{
	static class UAnnouncement_Basic_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnnouncement_Basic_C*>(UAnnouncement_Basic_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetTextForAction_ReturnValue                            (None)
