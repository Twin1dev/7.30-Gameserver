...
class UClass* UGA_Trap_FloorHoverboardSpeed_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Trap_FloorHoverboardSpeed_C");

	return Clss;
}


// GA_Trap_FloorHoverboardSpeed_C GA_Trap_FloorHoverboardSpeed.Default__GA_Trap_FloorHoverboardSpeed_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Trap_FloorHoverboardSpeed_C* UGA_Trap_FloorHoverboardSpeed_C::GetDefaultObj()
{
	static class UGA_Trap_FloorHoverboardSpeed_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Trap_FloorHoverboardSpeed_C*>(UGA_Trap_FloorHoverboardSpeed_C::StaticClass()->DefaultObject);
