...
public:
	...
	uint8                                        Pad_55F3[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  K2Node_ComponentBoundEvent_Text1;                  // 0x38(0x18)(ConstParm)
	...
	bool                                         CallFunc_TextIsEmpty_ReturnValue1;                 // 0x91(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Greater_IntInt_ReturnValue;               // 0x92(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_55FB[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
