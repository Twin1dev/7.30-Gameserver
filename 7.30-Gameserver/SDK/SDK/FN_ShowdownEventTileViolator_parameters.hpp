...
struct UShowdownEventTileViolator_C_ExecuteUbergraph_ShowdownEventTileViolator_Params
{
public:
	...
	enum class EFortShowdownEventState           CallFunc_GetEventState_ReturnValue;                // 0x13(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_5696[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_GetTournamentNextEvent_ReturnValue;       // 0x18(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_GetEventId_ReturnValue;                   // 0x30(0x10)(ZeroConstructor, HasGetValueTypeHash)
