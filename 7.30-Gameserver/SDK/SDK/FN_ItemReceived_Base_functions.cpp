...
class UClass* UItemReceived_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemReceived_Base_C");

	return Clss;
}


// ItemReceived_Base_C ItemReceived_Base.Default__ItemReceived_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemReceived_Base_C* UItemReceived_Base_C::GetDefaultObj()
{
	static class UItemReceived_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemReceived_Base_C*>(UItemReceived_Base_C::StaticClass()->DefaultObject);
...
// struct FFortReceivedItemLootInfo   CallFunc_Array_Get_Item1                                         (None)
...
// int32                              Temp_int_Variable1                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortReceivedItemLootInfo   CallFunc_Array_Get_Item2                                         (None)
...
// struct FFortAnalyticsEventAttributeCallFunc_ConstructAnalyticsAttribute_ReturnValue1                (None)
