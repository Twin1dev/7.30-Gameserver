...
class UClass* UPowerWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PowerWidget_C");

	return Clss;
}


// PowerWidget_C PowerWidget.Default__PowerWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPowerWidget_C* UPowerWidget_C::GetDefaultObj()
{
	static class UPowerWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPowerWidget_C*>(UPowerWidget_C::StaticClass()->DefaultObject);
...
class FText UPowerWidget_C::Get_RatingValueMinusLarge(class FText CallFunc_GetText_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPowerWidget_C_Get_RatingValueMinusLarge_Params Parms{};
...
// class FText                        CallFunc_Conv_BoolToText_ReturnValue1                            (None)
...
// class FText                        CallFunc_Conv_BoolToText_ReturnValue2                            (None)
