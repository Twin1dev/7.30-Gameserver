...
public:
	...
	struct FLinearColor                          CallFunc_Array_Get_Item1;                          // 0xE8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FStatGroupData                        CallFunc_Array_Get_Item;                           // 0xE8(0xB0)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x198(0x18)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x1B0(0x18)(None)
