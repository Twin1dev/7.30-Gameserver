...
public:
	...
	struct FLinearColor                          CallFunc_HSVToRGB_ReturnValue;                     // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue1;               // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FPointerEvent                         K2Node_Event_MouseEvent;                           // 0x120(0x70)(ConstParm)
	bool                                         K2Node_Event_IsDesignTime;                         // 0x190(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
