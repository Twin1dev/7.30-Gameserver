...
public:
	...
	uint8                                        Pad_5946[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5948[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_594D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_IsPlayerNameValid_OutErrorText;           // 0x118(0x18)(None)
	class UCommonInputSubsystem*                 CallFunc_GetContext_ReturnValue1;                  // 0x130(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
