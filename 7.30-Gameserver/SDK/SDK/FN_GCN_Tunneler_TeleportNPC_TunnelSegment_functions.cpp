...
class UClass* AGCN_Tunneler_TeleportNPC_TunnelSegment_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Tunneler_TeleportNPC_TunnelSegment_C");

	return Clss;
}


// GCN_Tunneler_TeleportNPC_TunnelSegment_C GCN_Tunneler_TeleportNPC_TunnelSegment.Default__GCN_Tunneler_TeleportNPC_TunnelSegment_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Tunneler_TeleportNPC_TunnelSegment_C* AGCN_Tunneler_TeleportNPC_TunnelSegment_C::GetDefaultObj()
{
	static class AGCN_Tunneler_TeleportNPC_TunnelSegment_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Tunneler_TeleportNPC_TunnelSegment_C*>(AGCN_Tunneler_TeleportNPC_TunnelSegment_C::StaticClass()->DefaultObject);
