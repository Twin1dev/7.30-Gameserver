...
class UClass* UGCN_Athena_Event_S8Leadup1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_Event_S8Leadup1_C");

	return Clss;
}


// GCN_Athena_Event_S8Leadup1_C GCN_Athena_Event_S8Leadup1.Default__GCN_Athena_Event_S8Leadup1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_Event_S8Leadup1_C* UGCN_Athena_Event_S8Leadup1_C::GetDefaultObj()
{
	static class UGCN_Athena_Event_S8Leadup1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_Event_S8Leadup1_C*>(UGCN_Athena_Event_S8Leadup1_C::StaticClass()->DefaultObject);
