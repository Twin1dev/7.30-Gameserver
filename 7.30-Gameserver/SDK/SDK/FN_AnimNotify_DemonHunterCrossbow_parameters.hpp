...
struct UAnimNotify_DemonHunterCrossbow_C_Received_Notify_Params
{
public:
	...
	uint8                                        Pad_51E2[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AB_DemonHunter_Crossbow_Athena_C*      K2Node_DynamicCast_AsB_Demon_Hunter_Crossbow_Athena; // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
