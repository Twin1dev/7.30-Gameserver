...
class UClass* UGA_Athena_C4_Passive_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_C4_Passive_C");

	return Clss;
}


// GA_Athena_C4_Passive_C GA_Athena_C4_Passive.Default__GA_Athena_C4_Passive_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_C4_Passive_C* UGA_Athena_C4_Passive_C::GetDefaultObj()
{
	static class UGA_Athena_C4_Passive_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_C4_Passive_C*>(UGA_Athena_C4_Passive_C::StaticClass()->DefaultObject);
...
void UGA_Athena_C4_Passive_C::EventReceived_66DB263A44E303CAE6B174AFF4094381(const struct FGameplayEventData& Payload)
{
	...
	Params::UGA_Athena_C4_Passive_C_EventReceived_66DB263A44E303CAE6B174AFF4094381_Params Parms{};
...
void UGA_Athena_C4_Passive_C::ExecuteUbergraph_GA_Athena_C4_Passive(int32 EntryPoint, const struct FGameplayEventData& K2Node_CustomEvent_Payload, const struct FGameplayEventData& Temp_struct_Variable, class UAbilityTask_WaitGameplayEvent* CallFunc_WaitGameplayEvent_ReturnValue, bool CallFunc_IsValid_ReturnValue, TArray<class AActor*>& CallFunc_GetTrackedGroupedActors_ReturnValue, class AActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_IntInt_ReturnValue, class AController* CallFunc_GetController_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_K2_GetItemQuantityOnPlayer_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue1, int32 CallFunc_K2_RemoveItemFromPlayer_ReturnValue, bool CallFunc_K2_CommitAbility_ReturnValue)
{
	...
	Params::UGA_Athena_C4_Passive_C_ExecuteUbergraph_GA_Athena_C4_Passive_Params Parms{};
