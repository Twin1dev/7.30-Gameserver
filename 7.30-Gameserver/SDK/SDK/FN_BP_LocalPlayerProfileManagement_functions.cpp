...
class UClass* UBP_LocalPlayerProfileManagement_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_LocalPlayerProfileManagement_C");

	return Clss;
}


// BP_LocalPlayerProfileManagement_C BP_LocalPlayerProfileManagement.Default__BP_LocalPlayerProfileManagement_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_LocalPlayerProfileManagement_C* UBP_LocalPlayerProfileManagement_C::GetDefaultObj()
{
	static class UBP_LocalPlayerProfileManagement_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_LocalPlayerProfileManagement_C*>(UBP_LocalPlayerProfileManagement_C::StaticClass()->DefaultObject);
...
void UBP_LocalPlayerProfileManagement_C::CloseProfileModal__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_LocalPlayerProfileManagement_C", "CloseProfileModal__DelegateSignature");
...
void UBP_LocalPlayerProfileManagement_C::OpenBannerEditor__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_LocalPlayerProfileManagement_C", "OpenBannerEditor__DelegateSignature");
