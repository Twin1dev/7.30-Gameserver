...
public:
	...
	struct FHomebaseSquad                        CallFunc_TryGetHomebaseSquadData_OutHomebaseSquad; // 0x38(0x88)(None)
	...
	struct FHomebaseSquadSlot                    CallFunc_Array_Get_Item;                           // 0xC8(0x68)(None)
};
...
public:
	...
	uint8                                        Pad_118C[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_118E[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
