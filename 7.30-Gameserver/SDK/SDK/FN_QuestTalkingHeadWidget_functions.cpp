...
class UClass* UQuestTalkingHeadWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestTalkingHeadWidget_C");

	return Clss;
}


// QuestTalkingHeadWidget_C QuestTalkingHeadWidget.Default__QuestTalkingHeadWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestTalkingHeadWidget_C* UQuestTalkingHeadWidget_C::GetDefaultObj()
{
	static class UQuestTalkingHeadWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestTalkingHeadWidget_C*>(UQuestTalkingHeadWidget_C::StaticClass()->DefaultObject);
