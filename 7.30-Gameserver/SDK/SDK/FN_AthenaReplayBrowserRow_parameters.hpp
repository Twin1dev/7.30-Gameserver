...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x68(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0xA8(0x18)(None)
...
public:
	...
	uint8                                        Pad_55EF[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0xB8(0x18)(None)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0x158(0x18)(None)
	class FString                                CallFunc_Conv_TextToString_ReturnValue;            // 0x170(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x180(0x18)(None)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue2;           // 0x1C0(0x18)(None)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue3;           // 0x1D8(0x18)(None)
