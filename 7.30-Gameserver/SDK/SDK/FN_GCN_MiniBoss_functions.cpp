...
class UClass* AGCN_MiniBoss_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_MiniBoss_C");

	return Clss;
}


// GCN_MiniBoss_C GCN_MiniBoss.Default__GCN_MiniBoss_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_MiniBoss_C* AGCN_MiniBoss_C::GetDefaultObj()
{
	static class AGCN_MiniBoss_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_MiniBoss_C*>(AGCN_MiniBoss_C::StaticClass()->DefaultObject);
