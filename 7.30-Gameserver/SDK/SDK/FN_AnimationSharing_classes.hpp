...
public:
	...
	uint8                                        Pad_24[0x17];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_28[0x3];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A[0x70];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2B[0x38];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2C[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2D[0x20];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2E[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2F[0x68];                                      // Fixing Size Of Struct [ Dumper-7 ]
