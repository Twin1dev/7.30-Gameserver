...
class UClass* ABluGlo_Node_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BluGlo_Node_C");

	return Clss;
}


// BluGlo_Node_C BluGlo_Node.Default__BluGlo_Node_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABluGlo_Node_C* ABluGlo_Node_C::GetDefaultObj()
{
	static class ABluGlo_Node_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABluGlo_Node_C*>(ABluGlo_Node_C::StaticClass()->DefaultObject);
