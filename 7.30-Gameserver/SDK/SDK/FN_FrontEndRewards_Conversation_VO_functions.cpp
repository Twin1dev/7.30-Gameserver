...
class UClass* UFrontEndRewards_Conversation_VO_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FrontEndRewards_Conversation_VO_C");

	return Clss;
}


// FrontEndRewards_Conversation_VO_C FrontEndRewards_Conversation_VO.Default__FrontEndRewards_Conversation_VO_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFrontEndRewards_Conversation_VO_C* UFrontEndRewards_Conversation_VO_C::GetDefaultObj()
{
	static class UFrontEndRewards_Conversation_VO_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFrontEndRewards_Conversation_VO_C*>(UFrontEndRewards_Conversation_VO_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetDataFromSentence_Text                                (None)
