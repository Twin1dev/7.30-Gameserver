...
class UClass* UGA_Athena_Balloons_Consumable_AltFireRelease_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_Balloons_Consumable_AltFireRelease_C");

	return Clss;
}


// GA_Athena_Balloons_Consumable_AltFireRelease_C GA_Athena_Balloons_Consumable_AltFireRelease.Default__GA_Athena_Balloons_Consumable_AltFireRelease_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_Balloons_Consumable_AltFireRelease_C* UGA_Athena_Balloons_Consumable_AltFireRelease_C::GetDefaultObj()
{
	static class UGA_Athena_Balloons_Consumable_AltFireRelease_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_Balloons_Consumable_AltFireRelease_C*>(UGA_Athena_Balloons_Consumable_AltFireRelease_C::StaticClass()->DefaultObject);
