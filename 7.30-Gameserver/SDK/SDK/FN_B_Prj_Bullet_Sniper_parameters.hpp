...
public:
	...
	uint8                                        Pad_649E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_IsDedicatedServer_ReturnValue;            // 0x12C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsMobilePlatform_ReturnValue;             // 0x12D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class USoundBase*                            K2Node_Select_Default;                             // 0x130(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UDecalComponent*                       CallFunc_SpawnDecalAtLocation_ReturnValue;         // 0x138(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
