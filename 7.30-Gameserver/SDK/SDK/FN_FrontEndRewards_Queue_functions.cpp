...
class UClass* UFrontEndRewards_Queue_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FrontEndRewards_Queue_C");

	return Clss;
}


// FrontEndRewards_Queue_C FrontEndRewards_Queue.Default__FrontEndRewards_Queue_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFrontEndRewards_Queue_C* UFrontEndRewards_Queue_C::GetDefaultObj()
{
	static class UFrontEndRewards_Queue_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFrontEndRewards_Queue_C*>(UFrontEndRewards_Queue_C::StaticClass()->DefaultObject);
