...
public:
	...
	uint8                                        Pad_CF5[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D0A[0x80];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xA8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_D0B[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D0C[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D0D[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
