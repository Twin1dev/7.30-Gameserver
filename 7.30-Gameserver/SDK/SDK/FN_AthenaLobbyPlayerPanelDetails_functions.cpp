...
class UClass* UAthenaLobbyPlayerPanelDetails_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaLobbyPlayerPanelDetails_C");

	return Clss;
}


// AthenaLobbyPlayerPanelDetails_C AthenaLobbyPlayerPanelDetails.Default__AthenaLobbyPlayerPanelDetails_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaLobbyPlayerPanelDetails_C* UAthenaLobbyPlayerPanelDetails_C::GetDefaultObj()
{
	static class UAthenaLobbyPlayerPanelDetails_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaLobbyPlayerPanelDetails_C*>(UAthenaLobbyPlayerPanelDetails_C::StaticClass()->DefaultObject);
