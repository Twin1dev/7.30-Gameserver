...
class UClass* UGCN_Deimos_Vehicle_GolfCart_HitFiend_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Deimos_Vehicle_GolfCart_HitFiend_C");

	return Clss;
}


// GCN_Deimos_Vehicle_GolfCart_HitFiend_C GCN_Deimos_Vehicle_GolfCart_HitFiend.Default__GCN_Deimos_Vehicle_GolfCart_HitFiend_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Deimos_Vehicle_GolfCart_HitFiend_C* UGCN_Deimos_Vehicle_GolfCart_HitFiend_C::GetDefaultObj()
{
	static class UGCN_Deimos_Vehicle_GolfCart_HitFiend_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Deimos_Vehicle_GolfCart_HitFiend_C*>(UGCN_Deimos_Vehicle_GolfCart_HitFiend_C::StaticClass()->DefaultObject);
...
void UGCN_Deimos_Vehicle_GolfCart_HitFiend_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, class UParticleSystemComponent* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue, class ABP_DeimosRift_C* K2Node_DynamicCast_AsBP_Deimos_Rift, bool K2Node_DynamicCast_bSuccess, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, const struct FRotator& CallFunc_FindLookAtRotation_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult, float CallFunc_VSize_ReturnValue, float CallFunc_Divide_FloatFloat_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue)
{
	...
	Params::UGCN_Deimos_Vehicle_GolfCart_HitFiend_C_OnBurst_Params Parms{};
