...
class UClass* UBP_LiveStreamerDescription_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_LiveStreamerDescription_C");

	return Clss;
}


// BP_LiveStreamerDescription_C BP_LiveStreamerDescription.Default__BP_LiveStreamerDescription_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_LiveStreamerDescription_C* UBP_LiveStreamerDescription_C::GetDefaultObj()
{
	static class UBP_LiveStreamerDescription_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_LiveStreamerDescription_C*>(UBP_LiveStreamerDescription_C::StaticClass()->DefaultObject);
...
// Parameters:
// class FText                        CallFunc_GetBroadcasterName_BroadcasterName                      (None)
