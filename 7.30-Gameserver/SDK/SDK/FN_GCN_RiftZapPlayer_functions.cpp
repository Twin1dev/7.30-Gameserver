...
class UClass* UGCN_RiftZapPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_RiftZapPlayer_C");

	return Clss;
}


// GCN_RiftZapPlayer_C GCN_RiftZapPlayer.Default__GCN_RiftZapPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_RiftZapPlayer_C* UGCN_RiftZapPlayer_C::GetDefaultObj()
{
	static class UGCN_RiftZapPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_RiftZapPlayer_C*>(UGCN_RiftZapPlayer_C::StaticClass()->DefaultObject);
