...
class UClass* UPieChartStatWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PieChartStatWidget_C");

	return Clss;
}


// PieChartStatWidget_C PieChartStatWidget.Default__PieChartStatWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPieChartStatWidget_C* UPieChartStatWidget_C::GetDefaultObj()
{
	static class UPieChartStatWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPieChartStatWidget_C*>(UPieChartStatWidget_C::StaticClass()->DefaultObject);
...
// struct FStatGroupData              CallFunc_Array_Get_Item                                          (None)
