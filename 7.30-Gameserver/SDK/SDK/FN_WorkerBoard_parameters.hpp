...
public:
	...
	TArray<class UFortAccountItem*>              CallFunc_GetAccountItemsByFilterType_OutItemList;  // 0x40(0x10)(ZeroConstructor, ReferenceParm)
	...
	TSoftObjectPtr<class UTexture2D>             CallFunc_GetLargePreviewImage_ReturnValue;         // 0x60(0x28)(HasGetValueTypeHash)
	...
	uint8                                        Pad_5EE7[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UStaticMeshComponent*>          K2Node_MakeArray_Array;                            // 0xA0(0x10)(ZeroConstructor, ReferenceParm)
};
...
public:
	...
	uint8                                        Pad_5EEA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
