...
class UClass* UGA_Athena_SlurpJuice_Trigger_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_SlurpJuice_Trigger_C");

	return Clss;
}


// GA_Athena_SlurpJuice_Trigger_C GA_Athena_SlurpJuice_Trigger.Default__GA_Athena_SlurpJuice_Trigger_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_SlurpJuice_Trigger_C* UGA_Athena_SlurpJuice_Trigger_C::GetDefaultObj()
{
	static class UGA_Athena_SlurpJuice_Trigger_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_SlurpJuice_Trigger_C*>(UGA_Athena_SlurpJuice_Trigger_C::StaticClass()->DefaultObject);
