...
class UClass* UGA_DefaultPlayer_Consumable_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_DefaultPlayer_Consumable_C");

	return Clss;
}


// GA_DefaultPlayer_Consumable_C GA_DefaultPlayer_Consumable.Default__GA_DefaultPlayer_Consumable_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_DefaultPlayer_Consumable_C* UGA_DefaultPlayer_Consumable_C::GetDefaultObj()
{
	static class UGA_DefaultPlayer_Consumable_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_DefaultPlayer_Consumable_C*>(UGA_DefaultPlayer_Consumable_C::StaticClass()->DefaultObject);
