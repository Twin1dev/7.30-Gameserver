...
class UClass* UQuestInfo_Widget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestInfo_Widget_C");

	return Clss;
}


// QuestInfo_Widget_C QuestInfo_Widget.Default__QuestInfo_Widget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestInfo_Widget_C* UQuestInfo_Widget_C::GetDefaultObj()
{
	static class UQuestInfo_Widget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestInfo_Widget_C*>(UQuestInfo_Widget_C::StaticClass()->DefaultObject);
