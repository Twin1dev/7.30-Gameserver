...
public:
	...
	bool                                         CallFunc_BreakHitResult_bBlockingHit;              // 0xA2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BreakHitResult_bInitialOverlap;           // 0xA3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x12C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_OnCollision_OutResult;                    // 0x138(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_5200[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0x130(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_5202[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRotator                              CallFunc_SpawnBounceFX_HitResultRotation;          // 0x16C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                               CallFunc_BreakHitResult_Location1;                 // 0x214(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_ImpactPoint1;              // 0x220(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_Normal1;                   // 0x22C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_ImpactNormal1;             // 0x238(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_BreakHitResult_TraceStart1;               // 0x270(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_BreakHitResult_TraceEnd1;                 // 0x27C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_MakeRotFromZ_ReturnValue;                 // 0x288(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue1;                // 0x294(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue1;         // 0x2A9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
