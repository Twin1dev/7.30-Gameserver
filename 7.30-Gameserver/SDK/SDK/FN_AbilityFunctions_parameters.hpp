...
public:
	...
	struct FScalableFloat                        K2Node_MakeStruct_ScalableFloat;                   // 0x88(0x20)(None)
	struct FScalableFloat                        K2Node_Select1_Default;                            // 0xA8(0x20)(None)
	struct FScalableFloat                        K2Node_Select2_Default;                            // 0xC8(0x20)(None)
};
...
public:
	...
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0xA8(0x100)(None)
...
public:
	...
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0x98(0x100)(None)
...
public:
	...
	uint8                                        Pad_3BA5[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UAbilityFunctions_C_DoNOTUseMinusBuildArrayOfHitActors_Params
{
public:
	struct FGameplayAbilityTargetDataHandle      TargetData;                                        // 0x0(0x20)(BlueprintVisible, BlueprintReadOnly, Parm)
