...
class UClass* UAthenaChallengeTreeEntry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaChallengeTreeEntry_C");

	return Clss;
}


// AthenaChallengeTreeEntry_C AthenaChallengeTreeEntry.Default__AthenaChallengeTreeEntry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaChallengeTreeEntry_C* UAthenaChallengeTreeEntry_C::GetDefaultObj()
{
	static class UAthenaChallengeTreeEntry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaChallengeTreeEntry_C*>(UAthenaChallengeTreeEntry_C::StaticClass()->DefaultObject);
