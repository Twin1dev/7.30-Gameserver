...
class UClass* UGCN_RefinedRift_Teleport_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_RefinedRift_Teleport_C");

	return Clss;
}


// GCN_RefinedRift_Teleport_C GCN_RefinedRift_Teleport.Default__GCN_RefinedRift_Teleport_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_RefinedRift_Teleport_C* UGCN_RefinedRift_Teleport_C::GetDefaultObj()
{
	static class UGCN_RefinedRift_Teleport_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_RefinedRift_Teleport_C*>(UGCN_RefinedRift_Teleport_C::StaticClass()->DefaultObject);
