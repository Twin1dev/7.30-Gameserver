...
class UClass* UGA__Festivus_Dance_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA__Festivus_Dance_C");

	return Clss;
}


// GA__Festivus_Dance_C GA__Festivus_Dance.Default__GA__Festivus_Dance_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA__Festivus_Dance_C* UGA__Festivus_Dance_C::GetDefaultObj()
{
	static class UGA__Festivus_Dance_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA__Festivus_Dance_C*>(UGA__Festivus_Dance_C::StaticClass()->DefaultObject);
