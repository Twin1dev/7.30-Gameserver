...
public:
	...
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0xF8(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x104(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
