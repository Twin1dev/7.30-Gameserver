...
class UClass* URewards_ItemCard_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Rewards_ItemCard_C");
...
class URewards_ItemCard_C* URewards_ItemCard_C::GetDefaultObj()
{
	static class URewards_ItemCard_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URewards_ItemCard_C*>(URewards_ItemCard_C::StaticClass()->DefaultObject);
