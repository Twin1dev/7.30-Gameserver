...
class UClass* AGCL_PunchPack_Jump_Charge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_PunchPack_Jump_Charge_C");

	return Clss;
}


// GCL_PunchPack_Jump_Charge_C GCL_PunchPack_Jump_Charge.Default__GCL_PunchPack_Jump_Charge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_PunchPack_Jump_Charge_C* AGCL_PunchPack_Jump_Charge_C::GetDefaultObj()
{
	static class AGCL_PunchPack_Jump_Charge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_PunchPack_Jump_Charge_C*>(AGCL_PunchPack_Jump_Charge_C::StaticClass()->DefaultObject);
