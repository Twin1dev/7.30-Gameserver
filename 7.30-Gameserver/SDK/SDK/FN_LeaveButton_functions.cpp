...
class UClass* ULeaveButton_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LeaveButton_C");

	return Clss;
}


// LeaveButton_C LeaveButton.Default__LeaveButton_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULeaveButton_C* ULeaveButton_C::GetDefaultObj()
{
	static class ULeaveButton_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULeaveButton_C*>(ULeaveButton_C::StaticClass()->DefaultObject);
