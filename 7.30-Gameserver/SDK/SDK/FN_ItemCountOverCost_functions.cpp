...
class UClass* UItemCountOverCost_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemCountOverCost_C");

	return Clss;
}


// ItemCountOverCost_C ItemCountOverCost.Default__ItemCountOverCost_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemCountOverCost_C* UItemCountOverCost_C::GetDefaultObj()
{
	static class UItemCountOverCost_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemCountOverCost_C*>(UItemCountOverCost_C::StaticClass()->DefaultObject);
