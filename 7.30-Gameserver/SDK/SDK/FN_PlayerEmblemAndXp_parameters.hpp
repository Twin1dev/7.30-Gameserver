...
public:
	...
	class FText                                  CallFunc_GetCurrentSeasonName_ReturnValue;         // 0x50(0x18)(None)
	...
	struct FFortItemQuantityPair                 CallFunc_GetNextSeasonReward_Reward;               // 0x90(0x40)(None)
	...
	uint8                                        Pad_4EDC[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FFortItemQuantityPair                 CallFunc_GetNextSeasonChaseReward_Reward;          // 0xE0(0x40)(None)
