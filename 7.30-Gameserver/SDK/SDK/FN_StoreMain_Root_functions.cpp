...
void UStoreMain_Root_C::SetupForCampaignUpsell(class UFortRuntimeOptions* NewLocalVar_0, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, bool CallFunc_IsDesktopPlatform_ReturnValue, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle1, TArray<class FString>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;
...
void UStoreMain_Root_C::SetupFirstFocusableTile(class UWidget* CallFunc_GetChildAt_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UWidget* CallFunc_GetChildAt_ReturnValue1)
{
	static class UFunction* Func = nullptr;
...
// enum class EFrontEndCamera         K2Node_Select2_Default                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UStoreMain_Root_C::ExecuteUbergraph_StoreMain_Root(int32 EntryPoint, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, enum class EFrontEndCamera Temp_byte_Variable2, enum class EFrontEndCamera Temp_byte_Variable3, bool CallFunc_Get_Main_Tab_Reference_ReturnValue, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, enum class ESlateVisibility Temp_byte_Variable4, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_GetEnableSplitWalletTextNotice_ReturnValue, bool CallFunc_IsActivated_ReturnValue, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable2, bool K2Node_Event_HasOtherPlatformCurrency, class FText K2Node_Event_CurrencyMessageLocText, bool CallFunc_BooleanAND_ReturnValue, class UFortStoreContext* CallFunc_GetContext_ReturnValue, bool CallFunc_HasAnyChildren_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue1, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_HasAnyChildren_ReturnValue1, enum class ESlateVisibility K2Node_Select1_Default, enum class EFrontEndCamera K2Node_Select2_Default, class UFortStoreFrontOfferInfo* K2Node_Event_OfferData, class FName CallFunc_GetStorefrontName_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, class UStoreMain_MTXOffer_C* CallFunc_Create_ReturnValue, class UGridSlot* CallFunc_AddChildToGrid_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, class UFortStoreContext* CallFunc_GetContext_ReturnValue2, int32 CallFunc_Subtract_IntInt_ReturnValue, class UFortStoreContext* CallFunc_GetContext_ReturnValue3, class UGridSlot* CallFunc_AddChildToGrid_ReturnValue1, int32 CallFunc_GetChildrenCount_ReturnValue1, int32 CallFunc_Subtract_IntInt_ReturnValue1)
{
	...
	Parms.CallFunc_AddChildToGrid_ReturnValue1 = CallFunc_AddChildToGrid_ReturnValue1;
	Parms.CallFunc_GetChildrenCount_ReturnValue1 = CallFunc_GetChildrenCount_ReturnValue1;
