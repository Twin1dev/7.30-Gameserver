...
class UClass* ALightningLsystem_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightningLsystem_C");

	return Clss;
}


// LightningLsystem_C LightningLSystem.Default__LightningLsystem_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ALightningLsystem_C* ALightningLsystem_C::GetDefaultObj()
{
	static class ALightningLsystem_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ALightningLsystem_C*>(ALightningLsystem_C::StaticClass()->DefaultObject);
