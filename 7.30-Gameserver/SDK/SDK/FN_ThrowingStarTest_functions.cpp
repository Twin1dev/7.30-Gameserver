...
class UClass* UThrowingStarTest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ThrowingStarTest_C");

	return Clss;
}


// ThrowingStarTest_C ThrowingStarTest.Default__ThrowingStarTest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UThrowingStarTest_C* UThrowingStarTest_C::GetDefaultObj()
{
	static class UThrowingStarTest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UThrowingStarTest_C*>(UThrowingStarTest_C::StaticClass()->DefaultObject);
