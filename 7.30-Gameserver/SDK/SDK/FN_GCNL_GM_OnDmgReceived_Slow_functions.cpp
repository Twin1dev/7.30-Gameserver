...
class UClass* AGCNL_GM_OnDmgReceived_Slow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_GM_OnDmgReceived_Slow_C");

	return Clss;
}


// GCNL_GM_OnDmgReceived_Slow_C GCNL_GM_OnDmgReceived_Slow.Default__GCNL_GM_OnDmgReceived_Slow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_GM_OnDmgReceived_Slow_C* AGCNL_GM_OnDmgReceived_Slow_C::GetDefaultObj()
{
	static class AGCNL_GM_OnDmgReceived_Slow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_GM_OnDmgReceived_Slow_C*>(AGCNL_GM_OnDmgReceived_Slow_C::StaticClass()->DefaultObject);
