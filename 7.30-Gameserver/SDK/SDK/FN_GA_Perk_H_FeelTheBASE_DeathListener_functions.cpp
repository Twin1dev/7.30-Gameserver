...
class UClass* UGA_Perk_H_FeelTheBASE_DeathListener_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Perk_H_FeelTheBASE_DeathListener_C");

	return Clss;
}


// GA_Perk_H_FeelTheBASE_DeathListener_C GA_Perk_H_FeelTheBASE_DeathListener.Default__GA_Perk_H_FeelTheBASE_DeathListener_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Perk_H_FeelTheBASE_DeathListener_C* UGA_Perk_H_FeelTheBASE_DeathListener_C::GetDefaultObj()
{
	static class UGA_Perk_H_FeelTheBASE_DeathListener_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Perk_H_FeelTheBASE_DeathListener_C*>(UGA_Perk_H_FeelTheBASE_DeathListener_C::StaticClass()->DefaultObject);
...
void UGA_Perk_H_FeelTheBASE_DeathListener_C::ActivateBASEStacks(int32 Stack_Count, class AB_Perk_C_Constructor_BASE_C* BASEReference, bool CallFunc_EqualEqual_IntInt_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue1, bool CallFunc_EqualEqual_IntInt_ReturnValue2)
{
