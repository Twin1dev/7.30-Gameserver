...
class UClass* UGAB_Hunting_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_Hunting_C");

	return Clss;
}


// GAB_Hunting_C GAB_Hunting.Default__GAB_Hunting_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_Hunting_C* UGAB_Hunting_C::GetDefaultObj()
{
	static class UGAB_Hunting_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_Hunting_C*>(UGAB_Hunting_C::StaticClass()->DefaultObject);
