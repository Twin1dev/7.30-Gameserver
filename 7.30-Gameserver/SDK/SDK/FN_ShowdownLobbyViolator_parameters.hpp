...
struct UShowdownLobbyViolator_C_ExecuteUbergraph_ShowdownLobbyViolator_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_51F3[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class EFortShowdownEventState           Temp_byte_Variable;                                // 0xB0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        Temp_int_Variable2;                                // 0xBC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable3;                                // 0xC0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        Temp_int_Variable6;                                // 0xCC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable7;                                // 0xD0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable8;                                // 0xD4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortShowdownEventState           CallFunc_GetEventState_ReturnValue;                // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData1;             // 0x148(0x40)(HasGetValueTypeHash)
	class FText                                  Temp_text_Variable7;                               // 0x188(0x18)(None)
	...
	class FText                                  Temp_text_Variable8;                               // 0x1E0(0x18)(None)
	enum class EFortShowdownEventState           Temp_byte_Variable1;                               // 0x1F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_51F6[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select1_Default;                            // 0x200(0x18)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue1;                 // 0x218(0x18)(None)
