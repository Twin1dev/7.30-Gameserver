...
class UClass* AB_Ranged_Dual_Generic_FerretVehicle_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Ranged_Dual_Generic_FerretVehicle_C");

	return Clss;
}


// B_Ranged_Dual_Generic_FerretVehicle_C B_Ranged_Dual_Generic_FerretVehicle.Default__B_Ranged_Dual_Generic_FerretVehicle_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Ranged_Dual_Generic_FerretVehicle_C* AB_Ranged_Dual_Generic_FerretVehicle_C::GetDefaultObj()
{
	static class AB_Ranged_Dual_Generic_FerretVehicle_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Ranged_Dual_Generic_FerretVehicle_C*>(AB_Ranged_Dual_Generic_FerretVehicle_C::StaticClass()->DefaultObject);
