...
class UClass* UGA_Athena_SuperTowerGrenadeWithTrajectory_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_SuperTowerGrenadeWithTrajectory_C");

	return Clss;
}


// GA_Athena_SuperTowerGrenadeWithTrajectory_C GA_Athena_SuperTowerGrenadeWithTrajectory.Default__GA_Athena_SuperTowerGrenadeWithTrajectory_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_SuperTowerGrenadeWithTrajectory_C* UGA_Athena_SuperTowerGrenadeWithTrajectory_C::GetDefaultObj()
{
	static class UGA_Athena_SuperTowerGrenadeWithTrajectory_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_SuperTowerGrenadeWithTrajectory_C*>(UGA_Athena_SuperTowerGrenadeWithTrajectory_C::StaticClass()->DefaultObject);
