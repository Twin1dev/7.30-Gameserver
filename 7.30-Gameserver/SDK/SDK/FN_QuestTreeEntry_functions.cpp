...
class UClass* UQuestTreeEntry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestTreeEntry_C");

	return Clss;
}


// QuestTreeEntry_C QuestTreeEntry.Default__QuestTreeEntry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestTreeEntry_C* UQuestTreeEntry_C::GetDefaultObj()
{
	static class UQuestTreeEntry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestTreeEntry_C*>(UQuestTreeEntry_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_Get_Streaming_Attached_Quest_Name_ModifiedName          (None)
