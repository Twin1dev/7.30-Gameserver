...
class UClass* ABP_DamageBalloon_Athena_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_DamageBalloon_Athena_C");

	return Clss;
}


// BP_DamageBalloon_Athena_C BP_DamageBalloon_Athena.Default__BP_DamageBalloon_Athena_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_DamageBalloon_Athena_C* ABP_DamageBalloon_Athena_C::GetDefaultObj()
{
	static class ABP_DamageBalloon_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_DamageBalloon_Athena_C*>(ABP_DamageBalloon_Athena_C::StaticClass()->DefaultObject);
