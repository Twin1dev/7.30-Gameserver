...
class UClass* UFortnite_M_Avg_Player_MenusScreen_AnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Fortnite_M_Avg_Player_MenusScreen_AnimBP_C");

	return Clss;
}


// Fortnite_M_Avg_Player_MenusScreen_AnimBP_C Fortnite_M_Avg_Player_MenusScreen_AnimBP.Default__Fortnite_M_Avg_Player_MenusScreen_AnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortnite_M_Avg_Player_MenusScreen_AnimBP_C* UFortnite_M_Avg_Player_MenusScreen_AnimBP_C::GetDefaultObj()
{
	static class UFortnite_M_Avg_Player_MenusScreen_AnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortnite_M_Avg_Player_MenusScreen_AnimBP_C*>(UFortnite_M_Avg_Player_MenusScreen_AnimBP_C::StaticClass()->DefaultObject);
