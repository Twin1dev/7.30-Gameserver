...
class UClass* UGAB_Melee_GenericCombo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_Melee_GenericCombo_C");

	return Clss;
}


// GAB_Melee_GenericCombo_C GAB_Melee_GenericCombo.Default__GAB_Melee_GenericCombo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_Melee_GenericCombo_C* UGAB_Melee_GenericCombo_C::GetDefaultObj()
{
	static class UGAB_Melee_GenericCombo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_Melee_GenericCombo_C*>(UGAB_Melee_GenericCombo_C::StaticClass()->DefaultObject);
