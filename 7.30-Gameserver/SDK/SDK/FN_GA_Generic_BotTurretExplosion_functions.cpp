...
class UClass* UGA_Generic_BotTurretExplosion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Generic_BotTurretExplosion_C");

	return Clss;
}


// GA_Generic_BotTurretExplosion_C GA_Generic_BotTurretExplosion.Default__GA_Generic_BotTurretExplosion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Generic_BotTurretExplosion_C* UGA_Generic_BotTurretExplosion_C::GetDefaultObj()
{
	static class UGA_Generic_BotTurretExplosion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Generic_BotTurretExplosion_C*>(UGA_Generic_BotTurretExplosion_C::StaticClass()->DefaultObject);
