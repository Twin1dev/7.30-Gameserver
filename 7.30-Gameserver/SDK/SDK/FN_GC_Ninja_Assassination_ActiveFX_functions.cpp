...
class UClass* AGC_Ninja_Assassination_ActiveFX_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Ninja_Assassination_ActiveFX_C");

	return Clss;
}


// GC_Ninja_Assassination_ActiveFX_C GC_Ninja_Assassination_ActiveFX.Default__GC_Ninja_Assassination_ActiveFX_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Ninja_Assassination_ActiveFX_C* AGC_Ninja_Assassination_ActiveFX_C::GetDefaultObj()
{
	static class AGC_Ninja_Assassination_ActiveFX_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Ninja_Assassination_ActiveFX_C*>(AGC_Ninja_Assassination_ActiveFX_C::StaticClass()->DefaultObject);
