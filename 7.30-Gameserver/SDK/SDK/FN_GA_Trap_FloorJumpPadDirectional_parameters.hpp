...
public:
	...
	struct FRotator                              LaunchRotation;                                    // 0x8(0xC)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6155[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	int32                                        CallFunc_GetAbilityLevel_ReturnValue;              // 0x14(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayEffectSpecHandle             CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0x38(0x10)(None)
	uint8                                        Pad_6158[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_615A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_615C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               CallFunc_GetVelocity_ReturnValue;                  // 0xE4(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0xF0(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_MakeRotator_ReturnValue;                  // 0x120(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FRotator                              K2Node_CustomEvent_LaunchRotation;                 // 0x168(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6161[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            K2Node_CustomEvent_TrapTransform;                  // 0x180(0x30)(IsPlainOldData, NoDestructor)
	struct FVector                               CallFunc_TransformDirection_ReturnValue;           // 0x1B0(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_6162[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6163[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6164[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable;                              // 0x238(0x20)(None)
	...
	uint8                                        Pad_6166[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1;             // 0x2AC(0x10)(ZeroConstructor, NoDestructor)
	int32                                        CallFunc_Array_Add_ReturnValue;                    // 0x2BC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayAbilityTargetDataHandle      K2Node_CustomEvent_TargetData1;                    // 0x2C0(0x20)(ConstParm)
	struct FGameplayTag                          K2Node_CustomEvent_ApplicationTag1;                // 0x2E0(0x8)(NoDestructor, HasGetValueTypeHash)
	TArray<struct FActiveGameplayEffectHandle>   CallFunc_ApplyGameplayEffectContainer_ReturnValue; // 0x2E8(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
};
