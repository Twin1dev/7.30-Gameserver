...
public:
	...
	bool                                         CallFunc_GetIsEnabled_ReturnValue1;                // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x11(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5BB6[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
