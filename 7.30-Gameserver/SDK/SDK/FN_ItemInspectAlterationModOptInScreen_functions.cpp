...
class UClass* UItemInspectAlterationModOptInScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemInspectAlterationModOptInScreen_C");

	return Clss;
}


// ItemInspectAlterationModOptInScreen_C ItemInspectAlterationModOptInScreen.Default__ItemInspectAlterationModOptInScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemInspectAlterationModOptInScreen_C* UItemInspectAlterationModOptInScreen_C::GetDefaultObj()
{
	static class UItemInspectAlterationModOptInScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemInspectAlterationModOptInScreen_C*>(UItemInspectAlterationModOptInScreen_C::StaticClass()->DefaultObject);
