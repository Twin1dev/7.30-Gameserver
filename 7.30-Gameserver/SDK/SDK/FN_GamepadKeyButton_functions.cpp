...
class UClass* UGamepadKeyButton_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GamepadKeyButton_C");

	return Clss;
}


// GamepadKeyButton_C GamepadKeyButton.Default__GamepadKeyButton_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGamepadKeyButton_C* UGamepadKeyButton_C::GetDefaultObj()
{
	static class UGamepadKeyButton_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGamepadKeyButton_C*>(UGamepadKeyButton_C::StaticClass()->DefaultObject);
