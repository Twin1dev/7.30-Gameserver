...
class UClass* UTooltipMinusBasicMultiLineMinusS_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Tooltip-BasicMultiLine-S_C");

	return Clss;
}


// Tooltip-BasicMultiLine-S_C Tooltip-BasicMultiLine-S.Default__Tooltip-BasicMultiLine-S_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTooltipMinusBasicMultiLineMinusS_C* UTooltipMinusBasicMultiLineMinusS_C::GetDefaultObj()
{
	static class UTooltipMinusBasicMultiLineMinusS_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTooltipMinusBasicMultiLineMinusS_C*>(UTooltipMinusBasicMultiLineMinusS_C::StaticClass()->DefaultObject);
...
struct FSlateBrush UTooltipMinusBasicMultiLineMinusS_C::Get_Icon_Brush(const struct FSlateBrush& CallFunc_MakeBrushFromAsset_ReturnValue)
{
	...
	Params::UTooltipMinusBasicMultiLineMinusS_C_Get_Icon_Brush_Params Parms{};
...
class FText UTooltipMinusBasicMultiLineMinusS_C::Get_Header_Text()
{
	...
	Params::UTooltipMinusBasicMultiLineMinusS_C_Get_Header_Text_Params Parms{};
...
void UTooltipMinusBasicMultiLineMinusS_C::Get_Body_Text(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, const struct FMargin& K2Node_MakeStruct_Margin, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UTooltipStatWidget_C* CallFunc_Create_ReturnValue, class FText CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, const struct FTooltipStat& K2Node_MakeStruct_TooltipStat, bool CallFunc_Less_IntInt_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue)
{
	...
	Params::UTooltipMinusBasicMultiLineMinusS_C_Get_Body_Text_Params Parms{};
...
void UTooltipMinusBasicMultiLineMinusS_C::ExecuteUbergraph_TooltipMinusBasicMultiLineMinusS(int32 EntryPoint, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool Temp_bool_Variable1, enum class ESlateVisibility Temp_byte_Variable2, enum class ESlateVisibility Temp_byte_Variable3, bool Temp_bool_Variable2, enum class ESlateVisibility Temp_byte_Variable4, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable3, enum class ESlateVisibility Temp_byte_Variable6, enum class ESlateVisibility Temp_byte_Variable7, bool Temp_bool_Variable4, enum class ESlateVisibility Temp_byte_Variable8, enum class ESlateVisibility Temp_byte_Variable9, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_TextIsEmpty_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, enum class ESlateVisibility K2Node_Select1_Default, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, enum class ESlateVisibility K2Node_Select2_Default, bool CallFunc_BooleanOR_ReturnValue1, enum class ESlateVisibility K2Node_Select3_Default, enum class ESlateVisibility K2Node_Select4_Default)
{
	...
	Params::UTooltipMinusBasicMultiLineMinusS_C_ExecuteUbergraph_TooltipMinusBasicMultiLineMinusS_Params Parms{};
