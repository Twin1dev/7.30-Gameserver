...
class UClass* AGCNL_GM_Snare_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_GM_Snare_C");

	return Clss;
}


// GCNL_GM_Snare_C GCNL_GM_Snare.Default__GCNL_GM_Snare_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_GM_Snare_C* AGCNL_GM_Snare_C::GetDefaultObj()
{
	static class AGCNL_GM_Snare_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_GM_Snare_C*>(AGCNL_GM_Snare_C::StaticClass()->DefaultObject);
