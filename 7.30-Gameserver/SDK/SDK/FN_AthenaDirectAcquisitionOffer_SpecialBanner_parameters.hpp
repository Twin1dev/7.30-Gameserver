...
public:
	...
	class FText                                  K2Node_Select2_Default;                            // 0xC8(0x18)(None)
	class FText                                  K2Node_Select3_Default;                            // 0xE0(0x18)(None)
	...
	class FText                                  K2Node_CustomEvent_SaleText;                       // 0x118(0x18)(None)
	...
	class FText                                  CallFunc_Map_Find_Value;                           // 0x148(0x18)(None)
