...
class UClass* UMissionActivationWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MissionActivationWidget_C");

	return Clss;
}


// MissionActivationWidget_C MissionActivationWidget.Default__MissionActivationWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMissionActivationWidget_C* UMissionActivationWidget_C::GetDefaultObj()
{
	static class UMissionActivationWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMissionActivationWidget_C*>(UMissionActivationWidget_C::StaticClass()->DefaultObject);
...
void UMissionActivationWidget_C::UnbindEvents(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3)
{
	static class UFunction* Func = nullptr;
...
void UMissionActivationWidget_C::BindEvents(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3)
{
	static class UFunction* Func = nullptr;
...
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        CallFunc_TimeSecondsToText_ReturnValue                           (None)
// bool                               CallFunc_BooleanAND_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor)
// float                              CallFunc_GetMissionObjectiveTimeRemaining_ReturnValue            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class FText                        CallFunc_GetMissionName_ReturnValue                              (None)
...
void UMissionActivationWidget_C::ExecuteUbergraph_MissionActivationWidget(int32 EntryPoint, bool Temp_bool_Variable, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, enum class EFortMissionActivationWidgetState K2Node_Event_ActiveState, enum class EFortMissionActivationWidgetState K2Node_Event_PreviousState, bool K2Node_SwitchEnum_CmpSuccess, bool K2Node_SwitchEnum1_CmpSuccess, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue2, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue3, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue4, bool CallFunc_IsValid_ReturnValue, enum class EFortVoteType CallFunc_GetMissionVoteType_ReturnValue, bool CallFunc_IsValid_ReturnValue1, enum class EFortVoteType K2Node_Event_VoteType1, bool K2Node_Event_bIsLocked, enum class EFortMissionActivationWidgetState CallFunc_GetCurrentState_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue5, enum class EFortVoteType CallFunc_GetMissionVoteType_ReturnValue1, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue1, bool CallFunc_BooleanOR_ReturnValue1, bool CallFunc_IsPlayerVoteInstigator_ReturnValue, bool CallFunc_IsVoteActive_ReturnValue, class UFortHUDContext* CallFunc_GetContext_ReturnValue1, bool CallFunc_IsPlayerVoteInstigator_ReturnValue1, bool CallFunc_IsVoteActive_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable, bool K2Node_SwitchEnum2_CmpSuccess, bool K2Node_SwitchEnum3_CmpSuccess, class UCommonButton* K2Node_ComponentBoundEvent_Button6, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button5, class UCommonButton* K2Node_ComponentBoundEvent_Button4, class UCommonButton* K2Node_ComponentBoundEvent_Button3, class UCommonButton* K2Node_ComponentBoundEvent_Button2, enum class ESlateVisibility Temp_byte_Variable1, class UCommonButton* K2Node_ComponentBoundEvent_Button1, class UCommonButton* K2Node_ComponentBoundEvent_Button, bool Temp_bool_Variable1, enum class ESlateVisibility K2Node_Select_Default, bool K2Node_Event_IsDesignTime, enum class EFortMissionActivationWidgetState CallFunc_GetCurrentState_ReturnValue1, bool K2Node_SwitchEnum4_CmpSuccess, int32 CallFunc_GetStartObjectiveBluGloRequirement_ReturnValue, int32 CallFunc_GetIncreaseDifficultyBluGloRequirement_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, class AFortMission* CallFunc_GetPrimaryMission_ReturnValue, class FText CallFunc_GetMissionName_ReturnValue, class AFortMission* CallFunc_GetPrimaryMission_ReturnValue1, class FText CallFunc_TextToUpper_ReturnValue, class UFortMissionInfo* CallFunc_GetPrimaryMissionInfo_ReturnValue, enum class ESlateVisibility Temp_byte_Variable2, bool CallFunc_IsInteractionEnabled_ReturnValue, bool CallFunc_IsInteractionEnabled_ReturnValue1, enum class ESlateVisibility Temp_byte_Variable3, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select1_Default, bool CallFunc_IsAnyVoteActive_ReturnValue, enum class EFortVoteType K2Node_CustomEvent_VoteType, bool K2Node_CustomEvent_Success, bool K2Node_SwitchEnum5_CmpSuccess, bool CallFunc_IsPlayerVoteInstigator_ReturnValue2, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue2, float Temp_float_Variable, float Temp_float_Variable1, bool Temp_bool_Variable3, float K2Node_Select2_Default, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue6, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue7, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue8, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue9, float Temp_float_Variable2, class AFortObjectiveBase* CallFunc_GetObjectiveByHandle_ReturnValue, float Temp_float_Variable3, class AGenericObjective_ReadyUp_C* K2Node_DynamicCast_AsGeneric_Objective_Ready_Up, bool K2Node_DynamicCast_bSuccess, float K2Node_Select3_Default, bool CallFunc_IsValid_ReturnValue2, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue10, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue11, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue12, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue13, enum class EFortVoteType K2Node_Event_VoteType, bool K2Node_Event_bIsVoteActive, int32 K2Node_Event_VoteResult, bool CallFunc_Not_PreBool_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsInteractionEnabled_ReturnValue2, bool CallFunc_IsInteractionEnabled_ReturnValue3, class UObject* K2Node_Event_InitObject, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue3)
{
	static class UFunction* Func = nullptr;
