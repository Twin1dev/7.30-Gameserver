...
class UClass* UPerkWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PerkWidget_C");

	return Clss;
}


// PerkWidget_C PerkWidget.Default__PerkWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPerkWidget_C* UPerkWidget_C::GetDefaultObj()
{
	static class UPerkWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPerkWidget_C*>(UPerkWidget_C::StaticClass()->DefaultObject);
