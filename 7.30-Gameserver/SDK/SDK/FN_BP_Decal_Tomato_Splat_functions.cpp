...
class UClass* ABP_Decal_Tomato_Splat_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Decal_Tomato_Splat_C");

	return Clss;
}


// BP_Decal_Tomato_Splat_C BP_Decal_Tomato_Splat.Default__BP_Decal_Tomato_Splat_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Decal_Tomato_Splat_C* ABP_Decal_Tomato_Splat_C::GetDefaultObj()
{
	static class ABP_Decal_Tomato_Splat_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Decal_Tomato_Splat_C*>(ABP_Decal_Tomato_Splat_C::StaticClass()->DefaultObject);
