...
class UClass* ACheckForMessageItems_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheckForMessageItems_C");

	return Clss;
}


// CheckForMessageItems_C CheckForMessageItems.Default__CheckForMessageItems_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACheckForMessageItems_C* ACheckForMessageItems_C::GetDefaultObj()
{
	static class ACheckForMessageItems_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACheckForMessageItems_C*>(ACheckForMessageItems_C::StaticClass()->DefaultObject);
