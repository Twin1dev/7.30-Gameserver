...
class UClass* AGCL_MedicPack_Healing_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_MedicPack_Healing_C");

	return Clss;
}


// GCL_MedicPack_Healing_C GCL_MedicPack_Healing.Default__GCL_MedicPack_Healing_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_MedicPack_Healing_C* AGCL_MedicPack_Healing_C::GetDefaultObj()
{
	static class AGCL_MedicPack_Healing_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_MedicPack_Healing_C*>(AGCL_MedicPack_Healing_C::StaticClass()->DefaultObject);
