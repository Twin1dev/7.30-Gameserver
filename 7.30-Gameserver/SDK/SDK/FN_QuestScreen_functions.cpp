...
class UClass* UQuestScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestScreen_C");

	return Clss;
}


// QuestScreen_C QuestScreen.Default__QuestScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestScreen_C* UQuestScreen_C::GetDefaultObj()
{
	static class UQuestScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestScreen_C*>(UQuestScreen_C::StaticClass()->DefaultObject);
...
void UQuestScreen_C::SelectQuest(class UFortQuestItem* Quest, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue, class UCommonUISubsystem* CallFunc_GetContext_ReturnValue1, class UFortQuestCategory* CallFunc_GetQuestCategory_ReturnValue, class UCommonInputManager* CallFunc_GetInputManager_ReturnValue, bool CallFunc_IsInputSuspended_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	static class UFunction* Func = nullptr;
