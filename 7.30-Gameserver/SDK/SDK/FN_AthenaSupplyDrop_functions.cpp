...
class UClass* AAthenaSupplyDrop_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaSupplyDrop_C");

	return Clss;
}


// AthenaSupplyDrop_C AthenaSupplyDrop.Default__AthenaSupplyDrop_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAthenaSupplyDrop_C* AAthenaSupplyDrop_C::GetDefaultObj()
{
	static class AAthenaSupplyDrop_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAthenaSupplyDrop_C*>(AAthenaSupplyDrop_C::StaticClass()->DefaultObject);
