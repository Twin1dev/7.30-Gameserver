...
class UClass* AGCNL_Durrrables_MovementSpeed_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Durrrables_MovementSpeed_C");

	return Clss;
}


// GCNL_Durrrables_MovementSpeed_C GCNL_Durrrables_MovementSpeed.Default__GCNL_Durrrables_MovementSpeed_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Durrrables_MovementSpeed_C* AGCNL_Durrrables_MovementSpeed_C::GetDefaultObj()
{
	static class AGCNL_Durrrables_MovementSpeed_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Durrrables_MovementSpeed_C*>(AGCNL_Durrrables_MovementSpeed_C::StaticClass()->DefaultObject);
