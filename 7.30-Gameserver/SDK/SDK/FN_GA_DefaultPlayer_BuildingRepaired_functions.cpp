...
class UClass* UGA_DefaultPlayer_BuildingRepaired_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_DefaultPlayer_BuildingRepaired_C");

	return Clss;
}


// GA_DefaultPlayer_BuildingRepaired_C GA_DefaultPlayer_BuildingRepaired.Default__GA_DefaultPlayer_BuildingRepaired_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_DefaultPlayer_BuildingRepaired_C* UGA_DefaultPlayer_BuildingRepaired_C::GetDefaultObj()
{
	static class UGA_DefaultPlayer_BuildingRepaired_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_DefaultPlayer_BuildingRepaired_C*>(UGA_DefaultPlayer_BuildingRepaired_C::StaticClass()->DefaultObject);
