...
class UClass* ACheckExpeditionRewardsAction_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheckExpeditionRewardsAction_C");

	return Clss;
}


// CheckExpeditionRewardsAction_C CheckExpeditionRewardsAction.Default__CheckExpeditionRewardsAction_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACheckExpeditionRewardsAction_C* ACheckExpeditionRewardsAction_C::GetDefaultObj()
{
	static class ACheckExpeditionRewardsAction_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACheckExpeditionRewardsAction_C*>(ACheckExpeditionRewardsAction_C::StaticClass()->DefaultObject);
