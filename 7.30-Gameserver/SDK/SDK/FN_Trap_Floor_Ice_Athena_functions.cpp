...
class UClass* ATrap_Floor_Ice_Athena_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Trap_Floor_Ice_Athena_C");

	return Clss;
}


// Trap_Floor_Ice_Athena_C Trap_Floor_Ice_Athena.Default__Trap_Floor_Ice_Athena_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATrap_Floor_Ice_Athena_C* ATrap_Floor_Ice_Athena_C::GetDefaultObj()
{
	static class ATrap_Floor_Ice_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATrap_Floor_Ice_Athena_C*>(ATrap_Floor_Ice_Athena_C::StaticClass()->DefaultObject);
