...
public:
	...
	uint8                                        Pad_5B74[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5B76[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Subtract_IntInt_ReturnValue1;             // 0x5C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_5BDA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5BE0[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_Format_ReturnValue4;                      // 0x280(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue5;                      // 0x328(0x18)(None)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array6;                           // 0x340(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue6;                      // 0x350(0x18)(None)
...
public:
	...
	uint8                                        Pad_5BF8[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0xE(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
