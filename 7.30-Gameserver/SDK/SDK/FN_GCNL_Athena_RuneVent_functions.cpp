...
class UClass* AGCNL_Athena_RuneVent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Athena_RuneVent_C");

	return Clss;
}


// GCNL_Athena_RuneVent_C GCNL_Athena_RuneVent.Default__GCNL_Athena_RuneVent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Athena_RuneVent_C* AGCNL_Athena_RuneVent_C::GetDefaultObj()
{
	static class AGCNL_Athena_RuneVent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Athena_RuneVent_C*>(AGCNL_Athena_RuneVent_C::StaticClass()->DefaultObject);
