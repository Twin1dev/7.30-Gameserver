...
class UClass* APlayerPawn_Constructor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerPawn_Constructor_C");

	return Clss;
}


// PlayerPawn_Constructor_C PlayerPawn_Constructor.Default__PlayerPawn_Constructor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class APlayerPawn_Constructor_C* APlayerPawn_Constructor_C::GetDefaultObj()
{
	static class APlayerPawn_Constructor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<APlayerPawn_Constructor_C*>(APlayerPawn_Constructor_C::StaticClass()->DefaultObject);
