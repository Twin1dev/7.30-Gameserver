...
class UClass* UBP_Shotgun_RG_BFPA_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Shotgun_RG_BFPA_C");

	return Clss;
}


// BP_Shotgun_RG_BFPA_C BP_Shotgun_RG_BFPA.Default__BP_Shotgun_RG_BFPA_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Shotgun_RG_BFPA_C* UBP_Shotgun_RG_BFPA_C::GetDefaultObj()
{
	static class UBP_Shotgun_RG_BFPA_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Shotgun_RG_BFPA_C*>(UBP_Shotgun_RG_BFPA_C::StaticClass()->DefaultObject);
