...
class UClass* UTopWeaponStatRow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TopWeaponStatRow_C");

	return Clss;
}


// TopWeaponStatRow_C TopWeaponStatRow.Default__TopWeaponStatRow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTopWeaponStatRow_C* UTopWeaponStatRow_C::GetDefaultObj()
{
	static class UTopWeaponStatRow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTopWeaponStatRow_C*>(UTopWeaponStatRow_C::StaticClass()->DefaultObject);
