...
class UClass* UItemWindow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemWindow_C");

	return Clss;
}


// ItemWindow_C ItemWindow.Default__ItemWindow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemWindow_C* UItemWindow_C::GetDefaultObj()
{
	static class UItemWindow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemWindow_C*>(UItemWindow_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_InternalToExternalRarity_ExternalRarity                 (None)
...
// class FText                        CallFunc_GetPeopleName_Result                                    (None)
// enum class EFortItemType           CallFunc_GetType_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_SwitchEnum_CmpSuccess                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        CallFunc_GetDisplayName_ReturnValue                              (None)
// struct FFormatArgumentData         K2Node_MakeStruct_FormatArgumentData                             (HasGetValueTypeHash)
