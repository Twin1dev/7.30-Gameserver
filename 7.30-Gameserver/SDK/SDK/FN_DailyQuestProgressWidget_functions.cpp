...
class UClass* UDailyQuestProgressWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DailyQuestProgressWidget_C");

	return Clss;
}


// DailyQuestProgressWidget_C DailyQuestProgressWidget.Default__DailyQuestProgressWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDailyQuestProgressWidget_C* UDailyQuestProgressWidget_C::GetDefaultObj()
{
	static class UDailyQuestProgressWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDailyQuestProgressWidget_C*>(UDailyQuestProgressWidget_C::StaticClass()->DefaultObject);
