...
class UClass* ACheckFrontEndDailyRewardsAction_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheckFrontEndDailyRewardsAction_C");

	return Clss;
}


// CheckFrontEndDailyRewardsAction_C CheckFrontEndDailyRewardsAction.Default__CheckFrontEndDailyRewardsAction_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACheckFrontEndDailyRewardsAction_C* ACheckFrontEndDailyRewardsAction_C::GetDefaultObj()
{
	static class ACheckFrontEndDailyRewardsAction_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACheckFrontEndDailyRewardsAction_C*>(ACheckFrontEndDailyRewardsAction_C::StaticClass()->DefaultObject);
