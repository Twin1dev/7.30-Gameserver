...
void UGAT_Athena_SneakySnowman_C::ExecuteUbergraph_GAT_Athena_SneakySnowman(int32 EntryPoint)
{
...
void UGAT_Athena_SneakySnowman_C::Remove_Snowman(class AFortPlayerPawn* Param_PlayerPawn)
{
	static class UFunction* Func = nullptr;
