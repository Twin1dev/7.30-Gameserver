...
class UClass* AB_Prj_Commando_FragGrenade_C::StaticClass()
{
...
class AB_Prj_Commando_FragGrenade_C* AB_Prj_Commando_FragGrenade_C::GetDefaultObj()
{
	static class AB_Prj_Commando_FragGrenade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Commando_FragGrenade_C*>(AB_Prj_Commando_FragGrenade_C::StaticClass()->DefaultObject);
