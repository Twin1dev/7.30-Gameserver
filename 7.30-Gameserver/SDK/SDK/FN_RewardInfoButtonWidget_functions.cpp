...
class UClass* URewardInfoButtonWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RewardInfoButtonWidget_C");

	return Clss;
}


// RewardInfoButtonWidget_C RewardInfoButtonWidget.Default__RewardInfoButtonWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URewardInfoButtonWidget_C* URewardInfoButtonWidget_C::GetDefaultObj()
{
	static class URewardInfoButtonWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URewardInfoButtonWidget_C*>(URewardInfoButtonWidget_C::StaticClass()->DefaultObject);
