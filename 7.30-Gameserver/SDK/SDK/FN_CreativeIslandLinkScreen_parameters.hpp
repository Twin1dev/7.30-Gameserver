...
public:
	...
	uint8                                        Pad_64F1[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UFortHUDContext*                       CallFunc_GetContext_ReturnValue1;                  // 0xD0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EFortCreativeIslandLinkValidationResult Temp_byte_Variable1;                               // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortUINavigationManager*              CallFunc_GetUINavigationManager_ReturnValue1;      // 0x110(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortUINavigationManager*              CallFunc_GetUINavigationManager_ReturnValue2;      // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0x160(0x18)(None)
	...
	struct FLinearColor                          K2Node_Select1_Default;                            // 0x184(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6502[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_Select2_Default;                            // 0x198(0x18)(None)
