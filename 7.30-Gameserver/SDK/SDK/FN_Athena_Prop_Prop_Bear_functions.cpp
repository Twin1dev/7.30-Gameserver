...
class UClass* AAthena_Prop_Prop_Bear_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Athena_Prop_Prop_Bear_C");

	return Clss;
}


// Athena_Prop_Prop_Bear_C Athena_Prop_Prop_Bear.Default__Athena_Prop_Prop_Bear_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAthena_Prop_Prop_Bear_C* AAthena_Prop_Prop_Bear_C::GetDefaultObj()
{
	static class AAthena_Prop_Prop_Bear_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAthena_Prop_Prop_Bear_C*>(AAthena_Prop_Prop_Bear_C::StaticClass()->DefaultObject);
