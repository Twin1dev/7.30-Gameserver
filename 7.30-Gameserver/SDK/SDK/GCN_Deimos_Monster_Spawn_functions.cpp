...
#include "GCN_Deimos_Monster_Spawn_classes.hpp"
#include "GCN_Deimos_Monster_Spawn_parameters.hpp"
...
void UGCN_Deimos_Monster_Spawn_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Deimos_Monster_Spawn_C_OnBurst Parms{};
...
bool UGCN_Deimos_Monster_Spawn_C::OnExecute(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters) const
{
	static class UFunction* Func = nullptr;
	...
	Params::GCN_Deimos_Monster_Spawn_C_OnExecute Parms{};
