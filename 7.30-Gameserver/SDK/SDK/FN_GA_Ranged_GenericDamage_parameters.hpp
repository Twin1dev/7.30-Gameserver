...
public:
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x120(0xA8)(None)
...
{
public:
	struct FGameplayEventData                    CallFunc_GetEventData_GameplayEventData;           // 0x0(0xA8)(None)
};
