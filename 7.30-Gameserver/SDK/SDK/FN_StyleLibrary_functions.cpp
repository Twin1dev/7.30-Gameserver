...
void UStyleLibrary_C::Get_Conning_Color_From_Difficulty_Value(int32 Player_Account_Level, float Content_Difficulty_Level, class UObject* __WorldContext, struct FLinearColor* Difficulty_Linear_Color, bool* Success, class FText* ToolTipText, int32* DifficultyValue, const TArray<class FText>& DifficultyColorNames, const TArray<class FText>& DifficultyTooltips, const TArray<int32>& DifficultyIndices, const TArray<struct FLinearColor>& DifficultyColors, const TArray<class FName>& RowNames, int32 DifficultyOut, float Content_DL_In, class FText DifficultyColorName, class FText ConningTooltipText, bool Valid, int32 Player_Account_Level_In, const TArray<float>& SPCutoffValues, const struct FLinearColor& DifficultyColor, int32 Temp_int_Variable, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue1, class FText CallFunc_Array_Get_Item, class FText CallFunc_Array_Get_Item1, const struct FLinearColor& CallFunc_Array_Get_Item2, TArray<float>& K2Node_MakeArray_Array, TArray<class FName>& K2Node_MakeArray_Array1, float CallFunc_Conv_IntToFloat_ReturnValue, TArray<struct FLinearColor>& K2Node_MakeArray_Array2, class FName CallFunc_Array_Get_Item3, int32 Temp_int_Array_Index_Variable, TArray<int32>& K2Node_MakeArray_Array3, int32 CallFunc_Array_Get_Item4, bool Temp_bool_True_if_break_was_hit_Variable, float CallFunc_Array_Get_Item5, bool CallFunc_Greater_FloatFloat_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, enum class EEvaluateCurveTableResult CallFunc_EvaluateCurveTableRow_OutResult, float CallFunc_EvaluateCurveTableRow_OutXY, bool CallFunc_BooleanAND_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, TArray<class FText>& K2Node_MakeArray_Array4, TArray<class FText>& K2Node_MakeArray_Array5)
{
	static class UFunction* Func = nullptr;
