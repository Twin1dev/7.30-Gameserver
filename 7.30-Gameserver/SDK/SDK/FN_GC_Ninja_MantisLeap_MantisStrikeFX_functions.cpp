...
class UClass* UGC_Ninja_MantisLeap_MantisStrikeFX_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Ninja_MantisLeap_MantisStrikeFX_C");

	return Clss;
}


// GC_Ninja_MantisLeap_MantisStrikeFX_C GC_Ninja_MantisLeap_MantisStrikeFX.Default__GC_Ninja_MantisLeap_MantisStrikeFX_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGC_Ninja_MantisLeap_MantisStrikeFX_C* UGC_Ninja_MantisLeap_MantisStrikeFX_C::GetDefaultObj()
{
	static class UGC_Ninja_MantisLeap_MantisStrikeFX_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGC_Ninja_MantisLeap_MantisStrikeFX_C*>(UGC_Ninja_MantisLeap_MantisStrikeFX_C::StaticClass()->DefaultObject);
