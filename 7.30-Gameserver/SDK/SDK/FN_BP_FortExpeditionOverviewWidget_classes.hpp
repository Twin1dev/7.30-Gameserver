...
public:
	...
	class UBP_FortExpeditionDetailsWidget_C*     BP_FortExpeditionDetailsWidget;                    // 0x260(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonWidgetSwitcher*                 CommonWidgetSwitcher_0;                            // 0x268(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UHeaderWithNav_C*                      HeaderWithNav;                                     // 0x270(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UBP_FortExpeditionMasterWidget_C*      ParentWidget;                                      // 0x2E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void RefreshActiveInputAction(class UObject* CallFunc_BP_GetSelectedItem_ReturnValue, class UFortExpeditionItem* K2Node_DynamicCast_AsFort_Expedition_Item, bool K2Node_DynamicCast_bSuccess);
	...
	void ExecuteUbergraph_BP_FortExpeditionOverviewWidget(int32 EntryPoint, int32 Temp_int_Array_Index_Variable, bool CallFunc_Handle_Back_PassThrough, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable1, class FName K2Node_Event_TabNameID, class FName K2Node_ComponentBoundEvent_TabId, class UCommonButton* K2Node_ComponentBoundEvent_TabButton, int32 Temp_int_Array_Index_Variable2, class UBP_FortExpeditionIconTabButton_C* K2Node_DynamicCast_AsBP_Fort_Expedition_Icon_Tab_Button, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_Array_Add_ReturnValue, class UFortExpeditionItem* K2Node_ComponentBoundEvent_Item2, class UBP_FortExpeditionIconTabButton_C* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable1, class UBP_FortExpeditionIconTabButton_C* CallFunc_Array_Get_Item1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue1, int32 CallFunc_Array_Length_ReturnValue1, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_GetNumItems_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, class UObject* K2Node_ComponentBoundEvent_Item1, class UFortExpeditionItem* K2Node_DynamicCast_AsFort_Expedition_Item, bool K2Node_DynamicCast_bSuccess1, class UObject* CallFunc_BP_GetSelectedItem_ReturnValue, class UFortExpeditionItem* K2Node_DynamicCast_AsFort_Expedition_Item1, bool K2Node_DynamicCast_bSuccess2, int32 Temp_int_Loop_Counter_Variable2, bool CallFunc_Less_IntInt_ReturnValue1, int32 CallFunc_Add_IntInt_ReturnValue2, class UObject* K2Node_ComponentBoundEvent_Item, class UBP_FortExpeditionIconTabButton_C* CallFunc_Array_Get_Item2, int32 CallFunc_Array_Length_ReturnValue2, bool CallFunc_Less_IntInt_ReturnValue2);
