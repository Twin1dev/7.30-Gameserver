...
class UClass* UGA_Trap_FloorJumpPadDirectional_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Trap_FloorJumpPadDirectional_C");

	return Clss;
}


// GA_Trap_FloorJumpPadDirectional_C GA_Trap_FloorJumpPadDirectional.Default__GA_Trap_FloorJumpPadDirectional_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Trap_FloorJumpPadDirectional_C* UGA_Trap_FloorJumpPadDirectional_C::GetDefaultObj()
{
	static class UGA_Trap_FloorJumpPadDirectional_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Trap_FloorJumpPadDirectional_C*>(UGA_Trap_FloorJumpPadDirectional_C::StaticClass()->DefaultObject);
...
// struct FRotator                    K2Node_CustomEvent_LaunchRotation                                (ZeroConstructor, IsPlainOldData, NoDestructor)
