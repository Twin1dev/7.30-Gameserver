...
class UClass* UBP_QuestExpiresWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_QuestExpiresWidget_C");

	return Clss;
}


// BP_QuestExpiresWidget_C BP_QuestExpiresWidget.Default__BP_QuestExpiresWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_QuestExpiresWidget_C* UBP_QuestExpiresWidget_C::GetDefaultObj()
{
	static class UBP_QuestExpiresWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_QuestExpiresWidget_C*>(UBP_QuestExpiresWidget_C::StaticClass()->DefaultObject);
