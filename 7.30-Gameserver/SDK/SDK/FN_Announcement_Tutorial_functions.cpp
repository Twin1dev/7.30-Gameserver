...
class UClass* UAnnouncement_Tutorial_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Announcement_Tutorial_C");

	return Clss;
}


// Announcement_Tutorial_C Announcement_Tutorial.Default__Announcement_Tutorial_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnnouncement_Tutorial_C* UAnnouncement_Tutorial_C::GetDefaultObj()
{
	static class UAnnouncement_Tutorial_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnnouncement_Tutorial_C*>(UAnnouncement_Tutorial_C::StaticClass()->DefaultObject);
...
// UDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor)
// struct FFortClientAnnouncementData_TutorialK2Node_MakeStruct_FortClientAnnouncementData_Tutorial            (None)
...
// struct FFortClientAnnouncementData_TutorialK2Node_CustomEvent_TutorialData                                  (None)
