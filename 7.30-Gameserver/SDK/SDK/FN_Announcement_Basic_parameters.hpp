...
public:
	...
	class FText                                  CallFunc_GetTextForAction_ReturnValue;             // 0x40(0x18)(None)
...
public:
	...
	bool                                         CallFunc_TextIsEmpty_ReturnValue1;                 // 0x3B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_3A26[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESlateVisibility                  Temp_byte_Variable1;                               // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x49(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3A27[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class ESlateVisibility                  Temp_byte_Variable3;                               // 0x5B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
