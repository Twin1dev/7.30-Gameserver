...
public:
	...
	TScriptInterface<class IGameplayTagAssetInterface> K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface; // 0x138(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TScriptInterface<class IGameplayTagAssetInterface> K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface1; // 0x1D8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_DynamicCast_bSuccess1;                      // 0x1E8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4CDE[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TScriptInterface<class IDeimosTypeInfo_C>    K2Node_DynamicCast_AsDeimos_Type_Info;             // 0x1F0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_HasAnyMatchingGameplayTags_ReturnValue1;  // 0x224(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable1;                               // 0x225(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
