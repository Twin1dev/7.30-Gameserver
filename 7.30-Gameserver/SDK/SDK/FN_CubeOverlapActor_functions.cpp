...
class UClass* ACubeOverlapActor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CubeOverlapActor_C");

	return Clss;
}


// CubeOverlapActor_C CubeOverlapActor.Default__CubeOverlapActor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACubeOverlapActor_C* ACubeOverlapActor_C::GetDefaultObj()
{
	static class ACubeOverlapActor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACubeOverlapActor_C*>(ACubeOverlapActor_C::StaticClass()->DefaultObject);
...
// struct FVector                     K2Node_CustomEvent_Normal2                                       (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FVector                     K2Node_CustomEvent_Normal1                                       (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
