...
class UClass* UBP_FortExpeditionListItem_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FortExpeditionListItem_C");

	return Clss;
}


// BP_FortExpeditionListItem_C BP_FortExpeditionListItem.Default__BP_FortExpeditionListItem_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_FortExpeditionListItem_C* UBP_FortExpeditionListItem_C::GetDefaultObj()
{
	static class UBP_FortExpeditionListItem_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FortExpeditionListItem_C*>(UBP_FortExpeditionListItem_C::StaticClass()->DefaultObject);
