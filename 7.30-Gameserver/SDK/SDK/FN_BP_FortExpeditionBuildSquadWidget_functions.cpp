...
class UClass* UBP_FortExpeditionBuildSquadWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FortExpeditionBuildSquadWidget_C");

	return Clss;
}


// BP_FortExpeditionBuildSquadWidget_C BP_FortExpeditionBuildSquadWidget.Default__BP_FortExpeditionBuildSquadWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_FortExpeditionBuildSquadWidget_C* UBP_FortExpeditionBuildSquadWidget_C::GetDefaultObj()
{
	static class UBP_FortExpeditionBuildSquadWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FortExpeditionBuildSquadWidget_C*>(UBP_FortExpeditionBuildSquadWidget_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_Format_ReturnValue                                      (None)
// class FText                        CallFunc_GetDisplayNameAndMultiBrushForTag_OutDisplayName        (None)
// struct FFortMultiSizeBrush         CallFunc_GetDisplayNameAndMultiBrushForTag_OutBrush              (None)
...
// Parameters:
// struct FSquadSlotSortTypes         CallFunc_TryGetSelectedSquadSlotSortTypes_OutSlotSortTypes       (None)
...
// struct FGameplayTagContainer       CallFunc_GetRequiredTags_ReturnValue                             (None)
...
// struct FFortCriteriaRequirementDataCallFunc_Array_Get_Item                                          (None)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_Length_ReturnValue1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Greater_IntInt_ReturnValue                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// int32                              Temp_int_Loop_Counter_Variable                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FSlateBrush                 CallFunc_Get_Bonus_Display_Name_and_Brush_OutBrush_Brush_M       (None)
// class FText                        CallFunc_Get_Bonus_Display_Name_and_Brush_OutDisplayName         (None)
...
// struct FFortTagUIData              CallFunc_GetUIDataForTag_OutData                                 (None)
