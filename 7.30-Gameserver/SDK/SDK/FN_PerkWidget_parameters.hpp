...
public:
	...
	class FText                                  CallFunc_GetTooltipTitle_ReturnValue;              // 0x78(0x18)(None)
};
...
public:
	...
	uint8                                        Pad_4946[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4949[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4950[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4952[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0xA8(0x88)(None)
	...
	struct FSlateBrush                           K2Node_Select1_Default;                            // 0x138(0x88)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_ResizedBrush;                 // 0x1C0(0x88)(None)
};
...
public:
	struct FLinearColor                          CallFunc_GetHighlightColor_Color;                  // 0x0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateBrush                           CallFunc_NoResourceBrush_ReturnValue;              // 0x10(0x88)(None)
...
public:
	...
	uint8                                        Pad_4958[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
