...
class UClass* USocialInviteListHeader::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SocialInviteListHeader");

	return Clss;
}


// SocialInviteListHeader SocialUMG.Default__SocialInviteListHeader
// (Public, ClassDefaultObject, ArchetypeObject)

class USocialInviteListHeader* USocialInviteListHeader::GetDefaultObj()
{
	static class USocialInviteListHeader* Default = nullptr;

	if (!Default)
		Default = static_cast<USocialInviteListHeader*>(USocialInviteListHeader::StaticClass()->DefaultObject);
...
class UClass* USocialInvite::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SocialInvite");

	return Clss;
}


// SocialInvite SocialUMG.Default__SocialInvite
// (Public, ClassDefaultObject, ArchetypeObject)

class USocialInvite* USocialInvite::GetDefaultObj()
{
	static class USocialInvite* Default = nullptr;

	if (!Default)
		Default = static_cast<USocialInvite*>(USocialInvite::StaticClass()->DefaultObject);
