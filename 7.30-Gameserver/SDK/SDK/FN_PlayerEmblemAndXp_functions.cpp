...
class UClass* UPlayerEmblemAndXp_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerEmblemAndXp_C");

	return Clss;
}


// PlayerEmblemAndXp_C PlayerEmblemAndXp.Default__PlayerEmblemAndXp_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerEmblemAndXp_C* UPlayerEmblemAndXp_C::GetDefaultObj()
{
	static class UPlayerEmblemAndXp_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerEmblemAndXp_C*>(UPlayerEmblemAndXp_C::StaticClass()->DefaultObject);
...
// bool                               Temp_bool_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FFortItemQuantityPair       CallFunc_GetNextSeasonReward_Reward                              (None)
...
// struct FFortItemQuantityPair       CallFunc_GetNextSeasonChaseReward_Reward                         (None)
