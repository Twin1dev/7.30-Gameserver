...
public:
	...
	class FText                                  CallFunc_GetFeedbackTitle_ReturnValue;             // 0x88(0x18)(None)
	bool                                         CallFunc_ShouldShowRateWidget_ReturnValue;         // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5C9A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5C9B[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
