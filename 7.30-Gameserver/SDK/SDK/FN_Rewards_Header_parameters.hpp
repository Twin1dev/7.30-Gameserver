...
public:
	...
	class FText                                  CallFunc_GetRewardHeaderText_ReturnValue;          // 0x30(0x18)(None)
...
public:
	...
	uint8                                        Pad_4A39[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4A3B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x148(0x18)(None)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array2;                           // 0x160(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x170(0x18)(None)
};
