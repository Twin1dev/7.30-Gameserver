...
public:
	...
	class UCommonInputSubsystem*                 CallFunc_GetGameInstanceSubsystem_ReturnValue1;    // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonInputSubsystem*                 CallFunc_GetGameInstanceSubsystem_ReturnValue2;    // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_41B8[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  Temp_text_Variable;                                // 0x50(0x18)(None)
	class FText                                  Temp_text_Variable1;                               // 0x68(0x18)(None)
	class FText                                  Temp_text_Variable2;                               // 0x80(0x18)(None)
	class FText                                  Temp_text_Variable3;                               // 0x98(0x18)(None)
	...
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0xB2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable1;                               // 0xB3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ETextJustify                      Temp_byte_Variable3;                               // 0xB4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETextJustify                      Temp_byte_Variable4;                               // 0xB5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                          Temp_struct_Variable1;                             // 0xC8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDateTime                             CallFunc_Now_ReturnValue;                          // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable5;                               // 0xE0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetTimespanAsText_ReturnValue;            // 0xF0(0x18)(None)
	...
	enum class ESlateVisibility                  Temp_byte_Variable6;                               // 0x128(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_Select1_Default;                            // 0x140(0x18)(None)
	...
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate1;             // 0x15C(0x10)(ZeroConstructor, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x16C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETextJustify                      K2Node_Select3_Default;                            // 0x16D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable3;                               // 0x16E(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select4_Default;                            // 0x16F(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
