...
{
public:
	TScriptInterface<class IFortTimespanDataSource> Value;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	uint8                                        Pad_5301[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  CallFunc_GetShortNameNumber_ReturnValue;           // 0xB0(0x18)(None)
	...
	class FText                                  CallFunc_GetShortName_ReturnValue;                 // 0xE8(0x18)(None)
	...
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x110(0x18)(None)
...
public:
	class UFortChallengeBundleInfo*              BundleInfo;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortChallengeBundleInfoLockedReason  CallFunc_IsUnlocked_LockedReason;                  // 0x8(0x28)(None)
	bool                                         CallFunc_IsUnlocked_ReturnValue;                   // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsCompleted_ReturnValue;                  // 0x31(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_ShouldReplaceBattleStarsWithAlternateReward_ReturnValue; // 0x40(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
