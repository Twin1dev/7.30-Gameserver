...
class UClass* UChallengeProgressWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ChallengeProgressWidget_C");

	return Clss;
}


// ChallengeProgressWidget_C ChallengeProgressWidget.Default__ChallengeProgressWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UChallengeProgressWidget_C* UChallengeProgressWidget_C::GetDefaultObj()
{
	static class UChallengeProgressWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UChallengeProgressWidget_C*>(UChallengeProgressWidget_C::StaticClass()->DefaultObject);
