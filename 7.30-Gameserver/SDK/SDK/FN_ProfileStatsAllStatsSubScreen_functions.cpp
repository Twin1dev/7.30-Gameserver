...
class UClass* UProfileStatsAllStatsSubScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ProfileStatsAllStatsSubScreen_C");

	return Clss;
}


// ProfileStatsAllStatsSubScreen_C ProfileStatsAllStatsSubScreen.Default__ProfileStatsAllStatsSubScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UProfileStatsAllStatsSubScreen_C* UProfileStatsAllStatsSubScreen_C::GetDefaultObj()
{
	static class UProfileStatsAllStatsSubScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UProfileStatsAllStatsSubScreen_C*>(UProfileStatsAllStatsSubScreen_C::StaticClass()->DefaultObject);
