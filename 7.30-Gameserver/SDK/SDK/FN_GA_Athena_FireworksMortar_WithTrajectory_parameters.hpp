...
public:
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x30(0xA8)(None)
	class AB_ProjectileTrajectory_Athena_FireworksMortar_C* K2Node_DynamicCast_AsB_Projectile_Trajectory_Athena_Fireworks_Mortar; // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
