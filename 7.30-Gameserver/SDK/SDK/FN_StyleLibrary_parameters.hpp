...
public:
	...
	class FText                                  CallFunc_Array_Get_Item1;                          // 0x128(0x18)(None)
	struct FLinearColor                          CallFunc_Array_Get_Item2;                          // 0x140(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<float>                                K2Node_MakeArray_Array;                            // 0x150(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class FName>                          K2Node_MakeArray_Array1;                           // 0x160(0x10)(ZeroConstructor, ReferenceParm)
	...
	TArray<struct FLinearColor>                  K2Node_MakeArray_Array2;                           // 0x178(0x10)(ZeroConstructor, ReferenceParm)
	class FName                                  CallFunc_Array_Get_Item3;                          // 0x188(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<int32>                                K2Node_MakeArray_Array3;                           // 0x198(0x10)(ZeroConstructor, ReferenceParm)
	int32                                        CallFunc_Array_Get_Item4;                          // 0x1A8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_Array_Get_Item5;                          // 0x1B0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3D2A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class FText>                          K2Node_MakeArray_Array4;                           // 0x1C8(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class FText>                          K2Node_MakeArray_Array5;                           // 0x1D8(0x10)(ZeroConstructor, ReferenceParm)
};
...
public:
	...
	uint8                                        Pad_3D34[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FLinearColor                          Temp_struct_Variable1;                             // 0xB64(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          Temp_struct_Variable2;                             // 0xB74(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                          K2Node_Select1_Default;                            // 0xB98(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_3D3D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
