...
class UClass* USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C");

	return Clss;
}


// SK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C SK_Weapon_Flotation_Balloon_Skeleton_AnimBP.Default__SK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C* USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C::GetDefaultObj()
{
	static class USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C*>(USK_Weapon_Flotation_Balloon_Skeleton_AnimBP_C::StaticClass()->DefaultObject);
...
// struct FRotator                    Temp_struct_Variable1                                            (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FRotator                    Temp_struct_Variable2                                            (ZeroConstructor, IsPlainOldData, NoDestructor)
