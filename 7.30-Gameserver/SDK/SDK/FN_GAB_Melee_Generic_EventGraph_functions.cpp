...
class UClass* UGAB_Melee_Generic_EventGraph_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_Melee_Generic_EventGraph_C");

	return Clss;
}


// GAB_Melee_Generic_EventGraph_C GAB_Melee_Generic_EventGraph.Default__GAB_Melee_Generic_EventGraph_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_Melee_Generic_EventGraph_C* UGAB_Melee_Generic_EventGraph_C::GetDefaultObj()
{
	static class UGAB_Melee_Generic_EventGraph_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_Melee_Generic_EventGraph_C*>(UGAB_Melee_Generic_EventGraph_C::StaticClass()->DefaultObject);
...
void UGAB_Melee_Generic_EventGraph_C::GetLocationAtDistanceFromActorFacing(class AActor* Actor, float Distance, struct FVector* Location, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
