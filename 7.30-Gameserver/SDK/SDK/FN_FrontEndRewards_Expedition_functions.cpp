...
class UClass* UFrontEndRewards_Expedition_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FrontEndRewards_Expedition_C");

	return Clss;
}


// FrontEndRewards_Expedition_C FrontEndRewards_Expedition.Default__FrontEndRewards_Expedition_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFrontEndRewards_Expedition_C* UFrontEndRewards_Expedition_C::GetDefaultObj()
{
	static class UFrontEndRewards_Expedition_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFrontEndRewards_Expedition_C*>(UFrontEndRewards_Expedition_C::StaticClass()->DefaultObject);
