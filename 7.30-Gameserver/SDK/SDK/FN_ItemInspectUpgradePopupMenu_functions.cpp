...
class UClass* UItemInspectUpgradePopupMenu_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemInspectUpgradePopupMenu_C");

	return Clss;
}


// ItemInspectUpgradePopupMenu_C ItemInspectUpgradePopupMenu.Default__ItemInspectUpgradePopupMenu_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemInspectUpgradePopupMenu_C* UItemInspectUpgradePopupMenu_C::GetDefaultObj()
{
	static class UItemInspectUpgradePopupMenu_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemInspectUpgradePopupMenu_C*>(UItemInspectUpgradePopupMenu_C::StaticClass()->DefaultObject);
