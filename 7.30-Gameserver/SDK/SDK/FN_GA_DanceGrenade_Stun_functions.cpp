...
class UClass* UGA_DanceGrenade_Stun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_DanceGrenade_Stun_C");

	return Clss;
}


// GA_DanceGrenade_Stun_C GA_DanceGrenade_Stun.Default__GA_DanceGrenade_Stun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_DanceGrenade_Stun_C* UGA_DanceGrenade_Stun_C::GetDefaultObj()
{
	static class UGA_DanceGrenade_Stun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_DanceGrenade_Stun_C*>(UGA_DanceGrenade_Stun_C::StaticClass()->DefaultObject);
