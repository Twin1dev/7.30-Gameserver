...
class UClass* UProfileStatsMatchesSubScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ProfileStatsMatchesSubScreen_C");

	return Clss;
}


// ProfileStatsMatchesSubScreen_C ProfileStatsMatchesSubScreen.Default__ProfileStatsMatchesSubScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UProfileStatsMatchesSubScreen_C* UProfileStatsMatchesSubScreen_C::GetDefaultObj()
{
	static class UProfileStatsMatchesSubScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UProfileStatsMatchesSubScreen_C*>(UProfileStatsMatchesSubScreen_C::StaticClass()->DefaultObject);
