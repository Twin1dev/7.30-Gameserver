...
class UClass* UGC_Tomato_Hit_Splat_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Tomato_Hit_Splat_C");

	return Clss;
}


// GC_Tomato_Hit_Splat_C GC_Tomato_Hit_Splat.Default__GC_Tomato_Hit_Splat_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGC_Tomato_Hit_Splat_C* UGC_Tomato_Hit_Splat_C::GetDefaultObj()
{
	static class UGC_Tomato_Hit_Splat_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGC_Tomato_Hit_Splat_C*>(UGC_Tomato_Hit_Splat_C::StaticClass()->DefaultObject);
...
void UGC_Tomato_Hit_Splat_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, float CallFunc_RandomFloatInRange_ReturnValue, const struct FRotator& CallFunc_MakeRotFromX_ReturnValue, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, float CallFunc_Add_FloatFloat_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldRotation_SweepHitResult)
{
	...
	Params::UGC_Tomato_Hit_Splat_C_OnBurst_Params Parms{};
