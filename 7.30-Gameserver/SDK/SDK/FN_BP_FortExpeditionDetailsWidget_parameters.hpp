...
public:
	...
	uint8                                        Pad_4B5C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetDisplayNameAndMultiBrushForTag_OutDisplayName; // 0x288(0x18)(None)
	struct FFortMultiSizeBrush                   CallFunc_GetDisplayNameAndMultiBrushForTag_OutBrush; // 0x2A0(0x330)(None)
...
public:
	...
	struct FFortCriteriaRequirementData          CallFunc_Array_Get_Item;                           // 0x20(0x20)(None)
	...
	struct FSlateBrush                           CallFunc_Get_Bonus_Display_Name_and_Brush_OutBrush_Brush_M; // 0x48(0x88)(None)
	class FText                                  CallFunc_Get_Bonus_Display_Name_and_Brush_OutDisplayName; // 0xD0(0x18)(None)
	struct FLinearColor                          CallFunc_Get_Bonus_Display_Name_and_Brush_OutRarityColor; // 0xE8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FGameplayTag                          CallFunc_GetVehicleTagFromSquadId_OutFoundVehicleTag; // 0x14(0x8)(NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GetVehicleTagFromSquadId_ReturnValue;     // 0x1C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_4B66[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UFortHomebaseUIContext*                CallFunc_GetContext_ReturnValue1;                  // 0x3C0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UFortItem*>                     CallFunc_GetItemsInSquad_ReturnValue;              // 0x3C8(0x10)(ZeroConstructor, ReferenceParm)
	float                                        CallFunc_CalculateTotalPower_ReturnValue;          // 0x3D8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_FTrunc_ReturnValue;                       // 0x3DC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_CalculateExpeditionPercentageChanceForSuccess_ReturnValue; // 0x3E0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_4B6C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class UFortExpeditionItemDefinition*         Item_Def;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimespan                             CallFunc_FromMinutes_ReturnValue;                  // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_4B80[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FConfirmationDialogAction             K2Node_MakeStruct_ConfirmationDialogAction;        // 0xA8(0xC8)(None)
