...
public:
	...
	uint8                                        Pad_4B86[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTag                          CallFunc_Array_Get_Item1;                          // 0x2CC(0x8)(NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FSlateBrush                           CallFunc_Get_Mission_Alert_Visual_Icon_OutBrush;   // 0x70(0x88)(None)
...
public:
	...
	uint8                                        Pad_4B88[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
