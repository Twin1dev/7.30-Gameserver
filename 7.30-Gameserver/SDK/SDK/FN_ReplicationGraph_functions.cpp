...
class UClass* UReplicationGraphNode_ConnectionDormanyNode::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ReplicationGraphNode_ConnectionDormanyNode");

	return Clss;
}


// ReplicationGraphNode_ConnectionDormanyNode ReplicationGraph.Default__ReplicationGraphNode_ConnectionDormanyNode
// (Public, ClassDefaultObject, ArchetypeObject)

class UReplicationGraphNode_ConnectionDormanyNode* UReplicationGraphNode_ConnectionDormanyNode::GetDefaultObj()
{
	static class UReplicationGraphNode_ConnectionDormanyNode* Default = nullptr;

	if (!Default)
		Default = static_cast<UReplicationGraphNode_ConnectionDormanyNode*>(UReplicationGraphNode_ConnectionDormanyNode::StaticClass()->DefaultObject);
