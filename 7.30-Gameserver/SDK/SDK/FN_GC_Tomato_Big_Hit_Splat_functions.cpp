...
class UClass* UGC_Tomato_Big_Hit_Splat_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Tomato_Big_Hit_Splat_C");

	return Clss;
}


// GC_Tomato_Big_Hit_Splat_C GC_Tomato_Big_Hit_Splat.Default__GC_Tomato_Big_Hit_Splat_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGC_Tomato_Big_Hit_Splat_C* UGC_Tomato_Big_Hit_Splat_C::GetDefaultObj()
{
	static class UGC_Tomato_Big_Hit_Splat_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGC_Tomato_Big_Hit_Splat_C*>(UGC_Tomato_Big_Hit_Splat_C::StaticClass()->DefaultObject);
