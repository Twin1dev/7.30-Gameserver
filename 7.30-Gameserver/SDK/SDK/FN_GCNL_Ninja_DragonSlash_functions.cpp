...
class UClass* AGCNL_Ninja_DragonSlash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Ninja_DragonSlash_C");

	return Clss;
}


// GCNL_Ninja_DragonSlash_C GCNL_Ninja_DragonSlash.Default__GCNL_Ninja_DragonSlash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Ninja_DragonSlash_C* AGCNL_Ninja_DragonSlash_C::GetDefaultObj()
{
	static class AGCNL_Ninja_DragonSlash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Ninja_DragonSlash_C*>(AGCNL_Ninja_DragonSlash_C::StaticClass()->DefaultObject);
