...
class UClass* URewards_Header_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Rewards_Header_C");

	return Clss;
}


// Rewards_Header_C Rewards_Header.Default__Rewards_Header_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URewards_Header_C* URewards_Header_C::GetDefaultObj()
{
	static class URewards_Header_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URewards_Header_C*>(URewards_Header_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetRewardHeaderText_ReturnValue                         (None)
