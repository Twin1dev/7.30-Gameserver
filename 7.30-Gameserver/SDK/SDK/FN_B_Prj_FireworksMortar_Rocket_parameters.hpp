...
struct AB_Prj_FireworksMortar_Rocket_C_UserConstructionScript_Params
{
public:
	...
	struct FVector                               CallFunc_K2_GetComponentScale_ReturnValue;         // 0x18(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Multiply_VectorVector_ReturnValue;        // 0x24(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*              CallFunc_CreateDynamicMaterialInstance_ReturnValue; // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x88 (0x88 - 0x0)
// Function B_Prj_FireworksMortar_Rocket.B_Prj_FireworksMortar_Rocket_C.OnBounce
struct AB_Prj_FireworksMortar_Rocket_C_OnBounce_Params
{
public:
...
struct AB_Prj_FireworksMortar_Rocket_C_OnExploded_Params
{
public:
...
struct AB_Prj_FireworksMortar_Rocket_C_ExecuteUbergraph_B_Prj_FireworksMortar_Rocket_Params
{
public:
	...
	uint8                                        Pad_61D5[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRotator                              CallFunc_Conv_VectorToRotator_ReturnValue;         // 0x148(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
