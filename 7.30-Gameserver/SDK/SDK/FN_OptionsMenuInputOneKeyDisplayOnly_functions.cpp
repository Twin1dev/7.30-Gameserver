...
class UClass* UOptionsMenuInputOneKeyDisplayOnly_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptionsMenuInputOneKeyDisplayOnly_C");

	return Clss;
}


// OptionsMenuInputOneKeyDisplayOnly_C OptionsMenuInputOneKeyDisplayOnly.Default__OptionsMenuInputOneKeyDisplayOnly_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOptionsMenuInputOneKeyDisplayOnly_C* UOptionsMenuInputOneKeyDisplayOnly_C::GetDefaultObj()
{
	static class UOptionsMenuInputOneKeyDisplayOnly_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptionsMenuInputOneKeyDisplayOnly_C*>(UOptionsMenuInputOneKeyDisplayOnly_C::StaticClass()->DefaultObject);
