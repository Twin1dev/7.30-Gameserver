...
class ABP_Fortnite_CommanderLights_C : public AActor
{
public:
	...
	uint8                                        Pad_4EC0[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
