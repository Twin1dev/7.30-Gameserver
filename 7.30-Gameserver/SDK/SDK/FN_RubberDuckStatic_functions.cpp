...
class UClass* ARubberDuckStatic_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RubberDuckStatic_C");

	return Clss;
}


// RubberDuckStatic_C RubberDuckStatic.Default__RubberDuckStatic_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ARubberDuckStatic_C* ARubberDuckStatic_C::GetDefaultObj()
{
	static class ARubberDuckStatic_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ARubberDuckStatic_C*>(ARubberDuckStatic_C::StaticClass()->DefaultObject);
...
void ARubberDuckStatic_C::OnDeathServer(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AController* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static class UFunction* Func = nullptr;
	...
	Params::ARubberDuckStatic_C_OnDeathServer_Params Parms{};
...
void ARubberDuckStatic_C::ExecuteUbergraph_RubberDuckStatic(int32 EntryPoint, bool CallFunc_DropChance_DropResult, bool Temp_bool_IsClosed_Variable, bool Temp_bool_Has_Been_Initd_Variable, float K2Node_Event_Damage, const struct FGameplayTagContainer& K2Node_Event_DamageTags, const struct FVector& K2Node_Event_Momentum, const struct FHitResult& K2Node_Event_HitInfo, class AController* K2Node_Event_InstigatedBy, class AActor* K2Node_Event_DamageCauser, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext, int32 Temp_int_Variable, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, class AFortPickup* CallFunc_K2_SpawnPickupInWorld_ReturnValue)
{
	...
	Params::ARubberDuckStatic_C_ExecuteUbergraph_RubberDuckStatic_Params Parms{};
