...
class UClass* UGA_Ferret_ExitHoldEvent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Ferret_ExitHoldEvent_C");

	return Clss;
}


// GA_Ferret_ExitHoldEvent_C GA_Ferret_ExitHoldEvent.Default__GA_Ferret_ExitHoldEvent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Ferret_ExitHoldEvent_C* UGA_Ferret_ExitHoldEvent_C::GetDefaultObj()
{
	static class UGA_Ferret_ExitHoldEvent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Ferret_ExitHoldEvent_C*>(UGA_Ferret_ExitHoldEvent_C::StaticClass()->DefaultObject);
