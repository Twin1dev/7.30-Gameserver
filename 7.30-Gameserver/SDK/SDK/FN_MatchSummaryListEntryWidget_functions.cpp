...
class UClass* UMatchSummaryListEntryWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MatchSummaryListEntryWidget_C");

	return Clss;
}


// MatchSummaryListEntryWidget_C MatchSummaryListEntryWidget.Default__MatchSummaryListEntryWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMatchSummaryListEntryWidget_C* UMatchSummaryListEntryWidget_C::GetDefaultObj()
{
	static class UMatchSummaryListEntryWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMatchSummaryListEntryWidget_C*>(UMatchSummaryListEntryWidget_C::StaticClass()->DefaultObject);
