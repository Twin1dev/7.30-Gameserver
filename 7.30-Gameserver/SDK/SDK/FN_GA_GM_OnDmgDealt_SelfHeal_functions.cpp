...
class UClass* UGA_GM_OnDmgDealt_SelfHeal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_GM_OnDmgDealt_SelfHeal_C");

	return Clss;
}


// GA_GM_OnDmgDealt_SelfHeal_C GA_GM_OnDmgDealt_SelfHeal.Default__GA_GM_OnDmgDealt_SelfHeal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_GM_OnDmgDealt_SelfHeal_C* UGA_GM_OnDmgDealt_SelfHeal_C::GetDefaultObj()
{
	static class UGA_GM_OnDmgDealt_SelfHeal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_GM_OnDmgDealt_SelfHeal_C*>(UGA_GM_OnDmgDealt_SelfHeal_C::StaticClass()->DefaultObject);
