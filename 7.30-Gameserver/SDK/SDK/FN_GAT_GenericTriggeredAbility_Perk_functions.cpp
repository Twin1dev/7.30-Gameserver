...
class UClass* UGAT_GenericTriggeredAbility_Perk_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAT_GenericTriggeredAbility_Perk_C");

	return Clss;
}


// GAT_GenericTriggeredAbility_Perk_C GAT_GenericTriggeredAbility_Perk.Default__GAT_GenericTriggeredAbility_Perk_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAT_GenericTriggeredAbility_Perk_C* UGAT_GenericTriggeredAbility_Perk_C::GetDefaultObj()
{
	static class UGAT_GenericTriggeredAbility_Perk_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAT_GenericTriggeredAbility_Perk_C*>(UGAT_GenericTriggeredAbility_Perk_C::StaticClass()->DefaultObject);
...
void UGAT_GenericTriggeredAbility_Perk_C::CalcStreakBreakerThreshold(float PROC_Chance__0Minus1_, int32* Streak_Breaker_Threshold, float Proc_Chance_Multiplier, float CallFunc_Multiply_FloatFloat_ReturnValue, int32 CallFunc_FTrunc_ReturnValue)
{
...
// TScriptInterface<class IFortInventoryOwnerInterface>CallFunc_AddRegenItemToInventoryOwner_InventoryOwner_CastInput   (ZeroConstructor, IsPlainOldData, NoDestructor)
