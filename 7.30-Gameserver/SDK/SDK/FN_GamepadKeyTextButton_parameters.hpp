...
public:
	...
	struct FKey                                  K2Node_CustomEvent_Key1;                           // 0x20(0x18)(HasGetValueTypeHash)
	class FText                                  K2Node_CustomEvent_DescText1;                      // 0x38(0x18)(None)
	class FName                                  K2Node_CustomEvent_ActionName1;                    // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  K2Node_CustomEvent_DescText;                       // 0x78(0x18)(None)
