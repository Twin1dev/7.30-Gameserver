...
class UClass* UGCN_C_L_BouncePlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_C_L_BouncePlayer_C");

	return Clss;
}


// GCN_C_L_BouncePlayer_C GCN_C_L_BouncePlayer.Default__GCN_C_L_BouncePlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_C_L_BouncePlayer_C* UGCN_C_L_BouncePlayer_C::GetDefaultObj()
{
	static class UGCN_C_L_BouncePlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_C_L_BouncePlayer_C*>(UGCN_C_L_BouncePlayer_C::StaticClass()->DefaultObject);
...
void UGCN_C_L_BouncePlayer_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, class FName ClosestSocket, class AFortPlayerPawn* TargetPlayer, class UParticleSystemComponent* CallFunc_Array_Get_Item, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, class AFortPlayerController* CallFunc_GetFortPlayerControllerFromActor_ReturnValue)
{
	...
	Params::UGCN_C_L_BouncePlayer_C_OnBurst_Params Parms{};
