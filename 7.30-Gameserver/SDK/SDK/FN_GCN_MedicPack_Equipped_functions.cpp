...
class UClass* UGCN_MedicPack_Equipped_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_MedicPack_Equipped_C");

	return Clss;
}


// GCN_MedicPack_Equipped_C GCN_MedicPack_Equipped.Default__GCN_MedicPack_Equipped_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_MedicPack_Equipped_C* UGCN_MedicPack_Equipped_C::GetDefaultObj()
{
	static class UGCN_MedicPack_Equipped_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_MedicPack_Equipped_C*>(UGCN_MedicPack_Equipped_C::StaticClass()->DefaultObject);
