...
class UClass* UGCN_Constructor_FeelTheBase_Activate_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Constructor_FeelTheBase_Activate_C");

	return Clss;
}


// GCN_Constructor_FeelTheBase_Activate_C GCN_Constructor_FeelTheBase_Activate.Default__GCN_Constructor_FeelTheBase_Activate_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Constructor_FeelTheBase_Activate_C* UGCN_Constructor_FeelTheBase_Activate_C::GetDefaultObj()
{
	static class UGCN_Constructor_FeelTheBase_Activate_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Constructor_FeelTheBase_Activate_C*>(UGCN_Constructor_FeelTheBase_Activate_C::StaticClass()->DefaultObject);
