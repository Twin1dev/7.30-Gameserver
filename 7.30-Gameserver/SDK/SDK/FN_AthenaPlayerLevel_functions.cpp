...
class UClass* UAthenaPlayerLevel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaPlayerLevel_C");

	return Clss;
}


// AthenaPlayerLevel_C AthenaPlayerLevel.Default__AthenaPlayerLevel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaPlayerLevel_C* UAthenaPlayerLevel_C::GetDefaultObj()
{
	static class UAthenaPlayerLevel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaPlayerLevel_C*>(UAthenaPlayerLevel_C::StaticClass()->DefaultObject);
...
void UAthenaPlayerLevel_C::AnimateBar(float CallFunc_Conv_IntToFloat_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue1, float CallFunc_Lerp_ReturnValue, int32 CallFunc_FTrunc_ReturnValue)
{
...
// struct FAthenaSeasonRewardLevelInfoCallFunc_GetSeasonLevelInfo_ReturnValue                          (None)
...
// struct FAthenaSeasonRewardLevelInfoCallFunc_GetSeasonLevelInfo_ReturnValue1                         (None)
