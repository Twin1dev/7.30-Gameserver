...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x98(0x18)(None)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0xB0(0x18)(None)
...
public:
	...
	class FString                                Temp_string_Variable4;                             // 0x58(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable5;                             // 0x68(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable6;                             // 0x78(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                Temp_string_Variable7;                             // 0x88(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_RandomInteger_ReturnValue1;               // 0xB0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_125[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                K2Node_Select1_Default;                            // 0xB8(0x10)(ZeroConstructor, HasGetValueTypeHash)
