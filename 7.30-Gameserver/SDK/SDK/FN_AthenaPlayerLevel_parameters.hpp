...
public:
	...
	float                                        CallFunc_Conv_IntToFloat_ReturnValue1;             // 0xA0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0xE8(0x18)(None)
...
public:
	...
	struct FAthenaSeasonRewardLevelInfo          CallFunc_GetSeasonLevelInfo_ReturnValue;           // 0x98(0x20)(None)
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue2;               // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Subtract_IntInt_ReturnValue1;             // 0xC8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortMcpProfileAthena*                 CallFunc_GetAthenaProfile_ReturnValue1;            // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0xE0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsValid_ReturnValue1;                     // 0xE1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5227[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAthenaSeasonRewardLevelInfo          CallFunc_GetSeasonLevelInfo_ReturnValue1;          // 0xE8(0x20)(None)
