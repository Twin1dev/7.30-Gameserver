...
class UClass* UGamepadMappingInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GamepadMappingInfo_C");

	return Clss;
}


// GamepadMappingInfo_C GamepadMappingInfo.Default__GamepadMappingInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGamepadMappingInfo_C* UGamepadMappingInfo_C::GetDefaultObj()
{
	static class UGamepadMappingInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGamepadMappingInfo_C*>(UGamepadMappingInfo_C::StaticClass()->DefaultObject);
