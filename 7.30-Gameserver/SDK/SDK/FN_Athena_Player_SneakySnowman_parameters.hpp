...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext1;                       // 0xD8(0x18)(None)
	...
	uint8                                        Pad_3FCE[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x1D0(0x18)(None)
};
