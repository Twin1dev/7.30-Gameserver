...
{
public:
	uint8                                        Pad_382[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_387[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_388[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FMovieSceneSequenceID                 ShotID;                                            // 0x84(0x4)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
