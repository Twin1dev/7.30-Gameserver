...
class UClass* UGameplayEffectTemplate::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameplayEffectTemplate");

	return Clss;
}


// GameplayEffectTemplate GameplayAbilities.Default__GameplayEffectTemplate
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameplayEffectTemplate* UGameplayEffectTemplate::GetDefaultObj()
{
	static class UGameplayEffectTemplate* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayEffectTemplate*>(UGameplayEffectTemplate::StaticClass()->DefaultObject);
