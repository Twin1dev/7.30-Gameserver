...
public:
	...
	uint8                                        Pad_5A99[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5AAA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0xE8(0x20)(None)
	...
	struct FGameplayEffectSpecHandle             CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0x110(0x10)(None)
