...
// Parameters:
// struct FFortErrorInfo                   Param_ErrorInfo                                        (BlueprintVisible, BlueprintReadOnly, Parm)

void UErrorEntry_C::SetErrorInfo(const struct FFortErrorInfo& Param_ErrorInfo)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ErrorInfo = std::move(Param_ErrorInfo);
